        ...
        return __generator2(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              if (!currentAccessTokens) return [3, 2];
        ...
        return __generator2(this, function(_b) {
          switch (_b.label) {
            case 0:
              ...
              if (!(request.authenticationScheme === AuthenticationScheme.POP)) return [3, 2];
        ...
        return __generator2(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              if (!request.nativeBroker) return [3, 2];
        ...
        return __generator2(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              _a.label = 1;
            case 1:
              if (!this.continuePolling(deviceCodeExpirationTime, userSpecifiedTimeout, request.cancel)) return [3, 8];
              thumbprint = {
                clientId: this.config.authOptions.clientId,
                authority: request.authority,
                scopes: request.scopes,
            ...
            case 2:
              ...
              if (!(response.body.error === Constants.AUTHORIZATION_PENDING)) return [3, 4];
        ...
        return __generator2(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              if (!request.skipCache) return [3, 2];
              return [4, this.executeTokenRequest(request, this.authority)];
            case 1:
              return [2, _a.sent()];
            case 2:
        ...
        return __generator2(this, function(_b) {
          switch (_b.label) {
            ...
            case 1:
              ...
              if (!request.skipCache) return [3, 3];
        ...
        return __generator2(this, function(_c) {
          switch (_c.label) {
            ...
            case 1:
              ...
              if (!((_a = this.authorityOptions.azureRegionConfiguration) === null || _a === void 0 ? void 0 : _a.azureRegion)) return [3, 3];
            ...
            case 4:
              ...
              if (!((_b = this.authorityOptions.azureRegionConfiguration) === null || _b === void 0 ? void 0 : _b.azureRegion)) return [3, 6];
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              ...
              if (!(request.claims && !StringUtils.isEmpty(request.claims))) return [3, 2];
              _a = validatedRequest;
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              if (!requestAuthority) return [3, 2];
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              if (!authCodeResponse.cloud_instance_host_name) return [3, 2];
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              if (!!StringUtils.isEmpty(requestUrl)) return [3, 7];
              ...
              if (!(typeof params.onRedirectNavigate === "function")) return [3, 4];
              this.logger.verbose("RedirectHandler.initiateAuthRequest: Invoking onRedirectNavigate callback");
              navigate = params.onRedirectNavigate(requestUrl);
              if (!(navigate !== false)) return [3, 2];
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (!(loginRequestUrlNormalized === currentUrlNormalized && this.config.auth.navigateToLoginRequestUrl)) return [3, 3];
            ...
            case 3:
              if (!!this.config.auth.navigateToLoginRequestUrl) return [3, 4];
              this.logger.verbose("NavigateToLoginRequestUrl set to false, handling hash");
              return [2, this.handleHash(responseHash, state, serverTelemetryManager)];
            case 4:
              if (!(!BrowserUtils.isInIframe() || this.config.system.allowRedirectInIframe)) return [3, 9];
              ...
              if (!(!loginRequestUrl || loginRequestUrl === "null")) return [3, 6];
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 3:
              ...
              if (!(logoutRequest && typeof logoutRequest.onRedirectNavigate === "function")) return [3, 7];
              navigate = logoutRequest.onRedirectNavigate(logoutUri);
              if (!(navigate !== false)) return [3, 5];
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              ...
              if (!this.navigateFrameWait) return [3, 2];
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              return [4, this.initializeAuthorizationRequest(__assign(__assign({}, request), { prompt: PromptValue.NONE }), InteractionType.Silent)];
            case 1:
          ...
          switch (_a.label) {
            ...
            case 4:
              ...
              if (serverParams.accountId) {
                ...
                userRequestState = ProtocolUtils.parseRequestState(this.browserCrypto, state).userRequestState;
                return [2, nativeInteractionClient.acquireToken(__assign(__assign({}, silentRequest), { state: userRequestState, prompt: PromptValue.NONE })).finally(function() {
                  _this.browserStorage.cleanRequestByState(state);
                })];
              }
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              if (!(cacheKeys.length === 0)) return [3, 4];
              _a.label = 1;
            case 1:
              _a.trys.push([1, 3, , 4]);
...
var TokenCache = (
  ...
  function() {
    ...
    TokenCache2.prototype.loadIdToken = function(idToken, homeAccountId, environment, tenantId, options) {
      ...
      var accountEntity = options.clientInfo ? AccountEntity.createAccount(options.clientInfo, homeAccountId, idAuthToken, void 0, void 0, void 0, environment) : AccountEntity.createGenericAccount(homeAccountId, idAuthToken, void 0, void 0, void 0, environment);
  ...
  function() {
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              ...
              if (!this.config.system.allowNativeBroker) return [3, 4];
              _b.label = 1;
            case 1:
              _b.trys.push([1, 3, , 4]);
              _a = this;
    ...
    ClientApplication2.prototype.ssoSilent = function(request) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          correlationId = this.getRequestCorrelationId(request);
          validRequest = __assign(__assign({}, request), { prompt: PromptValue.NONE, correlationId });
    ...
    ClientApplication2.prototype.acquireTokenByRefreshToken = function(request) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          ...
          return [2, silentRefreshClient.acquireToken(request).then(function(result) {
            ...
            if (isServerError && isInvalidGrantError && !isInteractionRequiredError) {
              ...
              return silentIframeClient.acquireToken(request).then(function(result) {
                atbrtMeasurement.endMeasurement({
                  success: true,
                  fromCache: result.fromCache
                });
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              if (!(NativeMessageHandler.isNativeAvailable(this.config, this.logger, this.nativeExtensionProvider, request.authenticationScheme) && account.nativeAccountId)) return [3, 1];
