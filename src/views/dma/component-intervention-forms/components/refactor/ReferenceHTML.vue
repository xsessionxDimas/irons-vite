...
const style = computed(() => {
  ...
  if (totalCol == 12) {
    borderBottom = hasStyle.value && !hasBorder.value && itemStyleBorder.value.bottom != 'none' ? `border-bottom: ${itemStyleBorder.value.bottom}; margin-bottom: 1rem; ` : ""
  }
