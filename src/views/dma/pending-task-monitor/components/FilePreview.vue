    ...
    <el-dialog
      ...
      <div class="row d-flex flex-column">
        <div class="photo-wrapper">
           <el-skeleton :loading="loader" animated>
              <template #template>
...
const openFirst = () => {
  isPdf.value = !props.blob.name
  console.log(isPdf.value)
}

const downloadPdfFromBlob = () => {
  const link = document.createElement('a');
  // create a blobURI pointing to our Blob
  link.href = URL.createObjectURL(props.blob);
  link.download = props.originalFilename ?? 'download.pdf';
