<template>
  <div
    :class="[widthStyle, potraitWidthStyle, paddingBottomCondition]"
    :style="style"
    class="pt-4">
    <div class="row justify-content-center">
      <div class="little-box rounded-circle d-flex p-3 justify-content-center align-items-center" :class="repairedClass('Not-Repaired')">
...
const repairedClass = (status = ""): string => {
  let className = ""
  if (status) {
    className = status === "Not-Repaired" ? "red" : "green";
  }
  return className;
};
