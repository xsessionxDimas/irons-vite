<template>
  <div :class="[widthStyle, potraitWidthStyle, paddingBottomCondition]"
  class="pt-2 px-2 d-flex d-flex justify-content-center"
  :style="style"
  v-loading="loading">
    <img :src="image" class="img-fluid" :style="imageStyle" alt="image-component"/>
  </div>
</template>
