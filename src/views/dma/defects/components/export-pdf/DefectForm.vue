    ...
    <pdfexport ref="contentToExport">
      <div :id="id" class="defect-review-eform" style="width: 100%;">
        <div class="report-header mb-2">
          ...
          <div class="el-dialog__title task-title avoid prevent-split" v-html="displayDesc(data.title, isIntervention)"></div>
        ...
        <div class="report task-group general-accordion py-1 px-5">
          <div class="avoid prevent-split">
            <h4 class="title ps-3">Photo of the defect identified (optional)</h4>
          </div>
        ...
        <div class="report task-group general-accordion py-1 px-5">
          <div class="report_section_header avoid prevent-split">
            <h4 class="title ps-3">Defect Symptom</h4>
          </div>
          <div class="report_section_body">
            <div class="p-2 d-flex" v-for="(item, index) in data.symptoms" :key="index">
              <div class="d-flex flex-fill flex-column">
        ...
        <div class="report task-group general-accordion py-1 px-5">
          <div class="report_section_header avoid prevent-split">
            <h4 class="title ps-3">Defect Cause</h4>
          </div>
          <div class="report_section_body">
...
const data = computed(() => {
  ...
  if ('previousCracks' in downloadData) {
    return {} as DefectYesDetail
  }
  return historyEformStore.DefectDetailDownload as DefectYesDetail
})
...
const isIntervention = computed(() => {
  return historyEformStore.IsIntervention
})
...
const calculateMaxWidthImage = (image: ImageItem) => {
