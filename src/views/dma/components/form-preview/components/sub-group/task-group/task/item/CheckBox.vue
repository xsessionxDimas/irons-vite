<template>
  <div :class="[widthStyle, potraitWidthStyle, paddingBottomCondition]" class="pt-2 px-2 d-flex align-items-center d-flex justify-content-center" :style="style">
    <div class="p-2">
      <div class="form-check checkbox-success item-checkbox">
        <input disabled class="form-check-input" type="checkbox" v-model="inputValue" >
      </div>
    </div>
  </div>
</template>
