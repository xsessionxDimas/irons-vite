<template>
  <div class="row px-2 my-2">
    ...
    <table
      ...
      "
    >
      <thead style="padding: 5px; height: 40px; text-align: left" class="prevent-split">
      ...
      <tbody
        style="background: white; padding: 5px; height: 40px; text-align: left"
      >
        <tr v-for="task in convertedTask" :key="task.key" class="prevent-split">
