<template>
  <div :class="[potraitWidthStyle, widthStyle, paddingBottomCondition]" class="pt-2 px-2 d-flex align-items-center d-flex justify-content-center prevent-split" :style="style">
    <div class="p-2">
      <div class="form-check checkbox-success item-checkbox">
        <input :disabled="true" class="form-check-input" type="checkbox" v-model="inputValue" >
      </div>
    </div>
  </div>
</template>
