<template>
  <div :class="[potraitWidthStyle, widthStyle, paddingBottomCondition]" class="pt-2 px-2 d-flex d-flex justify-content-center prevent-split" :style="style">
    <div class="px-2 w-100">
      <div class="form-check checkbox-success item-checkbox w-100 ps-0 d-flex">
        <div class="little-box rounded-circle d-flex flex-column justify-content-center cbm-confirm-checkbox"
          :class="'dot'">
          <div class="little-dot" v-if="!itemRef.value"></div>
          <img src="/media/svg/dma/icons/Check.png" style="width:28px" alt="" v-else />
