<template>
    ...
    <template #title>
      ...
      <span class="el-dialog__title task-title" v-html="displayDesc(NAData.title, isIntervention)" ref="defectDetailRef" ></span>
    </template>
    <div class="mt-1 p-2">
...
const prevDefectStore = usePreviewDefectFormStore()
...
const onFormClosed = async () => {
  prevDefectStore.setApprovalData({} as ApprovalData)
  emits("close")
