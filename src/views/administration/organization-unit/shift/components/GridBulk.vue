<template>
    ...
    :empty-text="'No Data'">
        ...
        <el-table-column prop="startHour" label="Start Hour" width="170" sortable />
        <el-table-column prop="startHourType" label="Start Hour Type" width="140" sortable />
        <el-table-column prop="endHour" label="End Hour" width="170" sortable />
        <el-table-column prop="endHourType" label="End Hour Type" width="140" sortable />
