<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="PositionDescription" label="Position Desc." min-width="200" sortable :sort-method="(a, b) => customSort(a, b, 'PositionDescription')"/>
          <el-table-column prop="StartDate" label="Start Date" width="170" sortable>
              <template #default="scope">
          ...
          <el-table-column prop="ChangedOn" label="Changed on" align="center" width="125" sortable>
              <template #default="scope">
