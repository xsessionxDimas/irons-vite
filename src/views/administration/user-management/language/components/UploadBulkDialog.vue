<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataLanguage.xlsx" target="_blank" id="link-download">here</a>
...
import {
  ValidatedItem
} from "@/core/types/entities/administration/user-management/language/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/administration/user-management/language/BulkItem";
