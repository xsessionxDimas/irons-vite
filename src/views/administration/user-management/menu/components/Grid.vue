<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="MenuName" label="Menu Name" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'MenuName')" />
      <el-table-column prop="PageName" label="Page Name" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'PageName')" />
      <el-table-column prop="MenuType" label="Menu Type" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'MenuType')" />
      <el-table-column prop="Level" label="Level" width="100" sortable />
      <el-table-column prop="Sequence" label="Sequence" width="120" sortable />
      <el-table-column prop="IsChild" label="Is Child" width="100" sortable />
      <el-table-column prop="ParentId" label="Parent Id" width="100" sortable />
      <el-table-column prop="IsMenu" label="Is Menu" width="100" sortable />
      <el-table-column prop="Section" label="Section" width="100" sortable :sort-method="(a, b) => customSort(a, b, 'Section')" />
