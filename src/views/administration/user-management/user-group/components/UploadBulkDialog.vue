<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataUserGroup.xlsx" target="_blank" id="link-download">here</a>
...
import {
  useUserGroupBulkStore
} from "@/store/pinia/administration/user-management/user-group/useUserGroupBulkStore";
import {
...
import {
  ValidatedItem
} from "@/core/types/entities/administration/user-management/user-group/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/administration/user-management/user-group/BulkItem";
...
const bulkStore = useUserGroupBulkStore();
...
const handleDownload = () => {
  ...
  handleDataToExcel("Master User Group", columns, data);
}
