...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("User Group", [
    {
      pageName: "Ironlake",
      pageRoute: "ironlake",
    },
    {
      ...
      pageRoute: "ironlake-rolemanagement-usergroup",
    },
    {
      pageName: "User Group",
      pageRoute: "ironlake-rolemanagement-usergroup",
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `UserGroup.xlsx`);
}
