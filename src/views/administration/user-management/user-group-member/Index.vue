...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("User Group Member", [
    {
      pageName: "Ironlake",
      pageRoute: "ironlake",
    },
    {
      ...
      pageRoute: "ironlake-rolemanagement-usergroupmember",
    },
    {
      pageName: "User Group Member",
      pageRoute: "ironlake-rolemanagement-usergroupmember",
    },
  ]);
  listStore.setPage(1);
  listStore.getEmployeeLookup();
  listStore.getUserGroupLookup();
});
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    ...
    }), `Master Data User Group Member.xlsx`);
}
