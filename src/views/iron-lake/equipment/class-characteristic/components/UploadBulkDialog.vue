<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataClassCharacteristic.xlsx" target="_blank" id="link-download">here</a>
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/equipment/class-characteristic/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-lake/equipment/class-characteristic/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("Class Characteristic", columns, data);
}
