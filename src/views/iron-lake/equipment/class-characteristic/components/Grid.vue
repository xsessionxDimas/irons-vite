<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="class" label="Class" min-width="200" sortable :sort-method="(a, b) => customSort(a, b, 'class')" />
      <el-table-column prop="characteristicType" label="Characteristic Type" min-width="250" sortable :sort-method="(a, b) => customSort(a, b, 'characteristicType')" />
