<template>
    ...
    :empty-text="'No Data'">
        ...
        <el-table-column prop="component" label="Component" width="130" sortable />
        <el-table-column prop="componentDescription" label="Component Desc." width="170" sortable />
        <el-table-column prop="level" label="Level" sortable />
        <el-table-column prop="startDate" label="startDate" sortable />
        <el-table-column prop="endDate" label="endDate" sortable />
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/equipment/component/ValidatedItem";
import {
  useComponentBulkStore
} from "@/store/pinia/iron-lake/equipment/component/useComponentBulkStore";
...
/* stores */
const bulkStore = useComponentBulkStore();
