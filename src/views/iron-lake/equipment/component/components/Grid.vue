<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="component" label="Component" width="150" sortable :sort-method="(a, b) => customSort(a, b, 'component')" />
          <el-table-column prop="componentDescription" label="Component Desc." min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'componentDescription')"/>
          <el-table-column prop="level" label="Level" align="center" width="100" sortable :sort-method="(a, b) => customSort(a, b, 'level')"/>
