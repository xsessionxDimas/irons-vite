<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataComponent.xlsx" target="_blank" id="link-download">here</a>
...
import {
  BulkItem
} from "@/core/types/entities/iron-lake/equipment/component/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("Component", columns, data);
}
