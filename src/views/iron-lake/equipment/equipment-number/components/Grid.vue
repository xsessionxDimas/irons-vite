<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="equipmentNumber" label="Equipment Number" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'equipmentNumber')" />
          <el-table-column prop="equipmentNumberDescription" label="Description" min-width="210" sortable :sort-method="(a, b) => customSort(a, b, 'equipmentNumberDescription')"/>
          <el-table-column prop="serialNumber" label="Serial Number" width="200" sortable :sort-method="(a, b) => customSort(a, b, 'serialNumber')" />
          <el-table-column prop="level" label="Level" width="120" sortable :sort-method="(a, b) => customSort(a, b, 'level')" />
