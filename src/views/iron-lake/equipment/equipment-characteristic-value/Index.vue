...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Equipment Characteristic Value", [
    {
      pageName: "Iron Lake",
      pageRoute: "ironlake",
    },
    {
      pageName: "Equipment",
      pageRoute: "useequipmentcharacteristicvalue",
    },
    {
      pageName: "Equipment Characteristic Value",
      pageRoute: "useequipmentcharacteristicvalue",
    },
  ]);
  listStore.setPage(1);
  await listStore.getLookup();
  await formStore.getEquipmentLookup();
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    ...
    }), `useEquipmentCharacteristicValue.xlsx`);
}
