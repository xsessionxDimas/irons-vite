<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataLevel.xlsx" target="_blank" id="link-download">here</a>
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/equipment/level/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-lake/equipment/level/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("Level", columns, data);
}
