<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="level" label="Level" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'level')" />
          <el-table-column prop="parent" label="Parent" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'parent')"/>
