<template>
    ...
    :empty-text="'No Data'">
          ...
          <el-table-column prop="equipment" label="Equipment Number" width="170" sortable />
          <el-table-column prop="objectType" label="Object Type" width="170" sortable />
          <el-table-column prop="plannerGroup" label="Planner Group" width="170" sortable />
          <el-table-column prop="maintenanceWorkCenter" label="Maintenance Work Center" width="170" sortable />
          <el-table-column prop="costCenter" label="Cost Center" width="170" sortable />
          <el-table-column prop="wbsElement" label="WBS Element" width="170" sortable />
          <el-table-column prop="level" label="Level" width="170" sortable />
          <el-table-column prop="equipmentType" label="Equipment Type" width="170" sortable />
          <el-table-column prop="equipmentGroup" label="Equipment Group" width="170" sortable />
          <el-table-column prop="equipmentModel" label="Equipment Model" width="170" sortable />
          <el-table-column prop="equipmentStatus" label="Equipment Status" width="170" sortable />
          <el-table-column prop="site" label="Site" width="170" sortable />
          <el-table-column prop="planningPlant" label="Planning Plant" width="170" sortable />
          <el-table-column prop="maintenancePlant" label="Maintenance Plant" width="170" sortable />
