<template>
  <el-dialog v-model="isVisible" v-loading="formStore.loading" title="New Data" width="60%" @close="handleCloseModal()">
    <transition name="fade">
      <ErrorAlert v-if="isError" :errorMessages="errors" @reset-form="handleResetError" />
    </transition>
    <Form id="kt_filter_form" class="row g-4 my-4" v-loading="formStore.loading">
      <div class="col-md-6 fv-row fv-plugins-icon-container">
        <AutoComplete :value="formData.equipment" placeholder="Add Equipment Number" label="Equipment Number" name="equipment"
          :options="listStore.equipmentOption" @handle-change="handleEquipmentNumberChange" />
      </div>
      <div class="col-md-6 fv-row fv-plugins-icon-container">
        <AutoComplete :value="formData.objectType" placeholder="Add Object Type" label="Object Type" name="objectType"
          :options="listStore.objectTypeOption" @handle-change="handleObjectTypeChange" />
      </div>
      <div class="col-md-6 fv-row fv-plugins-icon-container">
        <AutoComplete :value="formData.plannerGroup" placeholder="Add Planner Group" label="Planner Group" name="plannerGroup"
          :options="listStore.plannerGroupOption" @handle-change="handlePlannerGroupChange" />
      </div>
      <div class="col-md-6 fv-row fv-plugins-icon-container">
        <AutoComplete :value="formData.maintenanceWorkCenter" placeholder="Add Maintenance Work Center" label="Maintenance Work Center"
          name="maintenanceWorkCenter" :options="listStore.maintenanceWorkCenterOption"
          @handle-change="handleMaintenanceWorkCenterChange" />
      </div>
      <div class="col-md-6 fv-row fv-plugins-icon-container">
        <AutoComplete :value="formData.costCenter" placeholder="Add Cost Center" label="Cost Center" name="costCenter"
          :options="listStore.costCenterOption" @handle-change="handleCostCenterChange" />
      </div>
      <div class="col-md-6 fv-row fv-plugins-icon-container">
        <AutoComplete :value="formData.wbsElement" placeholder="Add WBS Element" label="WBS Element" name="wbsElement"
          :options="listStore.wbsElementOption" @handle-change="handleWbsElementChange" />
      </div>
      <div class="col-md-6 fv-row fv-plugins-icon-container">
        <AutoComplete :value="formData.level" placeholder="Add Level" label="Level" name="level" :options="listStore.levelOption"
          @handle-change="handleLevelChange" />
      </div>
      <div class="col-md-6 fv-row fv-plugins-icon-container">
        <AutoComplete :value="formData.equipmentType" placeholder="Add Equipment Type" label="Equipment Type" name="equipmentType"
          :options="listStore.equipmentTypeOption" @handle-change="handleEquipmentTypeChange" />
      </div>
      <div class="col-md-6 fv-row fv-plugins-icon-container">
        <AutoComplete :value="formData.equipmentGroup" placeholder="Add Equipment Group" label="Equipment Group" name="equipmentGroup"
          :options="listStore.equipmentGroupOption" @handle-change="handleEquipmentGroupChange" />
      </div>
      <div class="col-md-6 fv-row fv-plugins-icon-container">
        <AutoComplete :value="formData.equipmentModel" placeholder="Add Equipment Model" label="Equipment Model" name="equipmentModel"
          :options="listStore.equipmentModelOption" @handle-change="handleEquipmentModelChange" />
      </div>
      <div class="col-md-6 fv-row fv-plugins-icon-container">
        <AutoComplete :value="formData.equipmentStatus" placeholder="Add Equipment Status" label="Equipment Status" name="equipmentStatus"
          :options="listStore.equipmentStatusOption" @handle-change="handleEquipmentStatusChange" />
      </div>
      <div class="col-md-6 fv-row fv-plugins-icon-container">
        <AutoComplete :value="formData.site" placeholder="Add Site" label="Site" name="site" :options="listStore.siteOption"
          @handle-change="handleSiteChange" />
      </div>
      <div class="col-md-6 fv-row fv-plugins-icon-container">
        <AutoComplete :value="formData.planningPlant" placeholder="Add Planning Plant" label="Planning Plant" name="planningPlant"
          :options="listStore.planningPlantOption" @handle-change="handlePlanningPlantChange" />
      </div>
      <div class="col-md-6 fv-row fv-plugins-icon-container">
        <AutoComplete :value="formData.maintenancePlant" placeholder="Add Maintenance Plant" label="Maintenance Plant" name="maintenancePlant"
