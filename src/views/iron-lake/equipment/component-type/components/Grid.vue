<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="componentType" label="Component Type" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'componentType')" />
          <el-table-column prop="componentTypeDescription" label="Component Type Desc" min-width="200" sortable :sort-method="(a, b) => customSort(a, b, 'componentTypeDescription')"/>
