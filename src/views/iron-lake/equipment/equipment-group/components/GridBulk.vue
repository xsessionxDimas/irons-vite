<template>
    ...
    :empty-text="'No Data'">
        ...
        <el-table-column prop="equipmentGroup" label="Equipment Group" width="300" sortable />
        <el-table-column prop="equipmentGroupDescription" label="Equipment Group Desc." sortable />
