<template>
    ...
    :empty-text="'No Data'">
        ...
        <el-table-column prop="maintenanceWorkCenter" label="Maintenance Work Center" width="300" sortable />
        <el-table-column prop="maintenanceWorkCenterDescription" label="Maintenance Work Center Desc." sortable />
