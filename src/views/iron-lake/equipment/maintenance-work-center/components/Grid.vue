<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="maintenanceWorkCenter" label="Maintenance Work Center" width="250" sortable :sort-method="(a, b) => customSort(a, b, 'maintenanceWorkCenter')" />
          <el-table-column prop="maintenanceWorkCenterDescription" label="Maintenance Work Center Desc." min-width="250" sortable :sort-method="(a, b) => customSort(a, b, 'maintenanceWorkCenterDescription')"/>
