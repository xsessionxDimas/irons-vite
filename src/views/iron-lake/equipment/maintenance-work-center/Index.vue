...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Maintenance Work Center", [
    {
      pageName: "Iron Lake",
      pageRoute: "ironlake",
    },
    {
      pageName: "Equipment",
      pageRoute: "maintenanceworkcenter",
    },
    {
      pageName: "Maintenance Work Center",
      pageRoute: "maintenanceworkcenter",
    },
  ]);
  listStore.setPage(1);
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `Maintenance Work Center.xlsx`);
}
