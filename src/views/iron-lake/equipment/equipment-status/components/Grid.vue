<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="equipment" label="Equipment" min-width="200" sortable :sort-method="(a, b) => customSort(a, b, 'equipment')" />
      <el-table-column prop="systemStatus" label="System Status" min-width="200" sortable :sort-method="(a, b) => customSort(a, b, 'systemStatus')" />
      <el-table-column prop="status" label="Status" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'status')" />
      <el-table-column prop="subStatus" label="Sub Status" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'subStatus')" />
      ...
      <!-- <el-table-column prop="equipmentStatusType" label="Status ID" width="170" sortable />
      <el-table-column prop="equipmentStatus" label="Status Code" width="170" sortable />
      <el-table-column prop="equipmentStatusDescription" label="Status Code Description" min-width="210" sortable/> -->
