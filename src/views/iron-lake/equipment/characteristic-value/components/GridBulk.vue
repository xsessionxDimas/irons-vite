<template>
  ...
  >
    ...
    <el-table-column prop="characteristicValue" label="Characteristic Value" width="300" sortable />
    <el-table-column prop="characteristicValueDescription" label="Characteristic Value Description" width="300" sortable />
