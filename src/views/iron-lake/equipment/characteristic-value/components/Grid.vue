<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="characteristicValue" label="Characteristic Value" min-width="200" sortable :sort-method="(a, b) => customSort(a, b, 'characteristicValue')" />
      <el-table-column prop="characteristicValueDescription" label="Characteristic Value Description" min-width="300" sortable :sort-method="(a, b) => customSort(a, b, 'characteristicValueDescription')" />
...
import {
  useCharacteristicValueListStore
} from "@/store/pinia/iron-lake/equipment/characteristic-value/useCharacteristicValueListStore";
import {
  useCharacteristicValueFormStore
} from "@/store/pinia/iron-lake/equipment/characteristic-value/useCharacteristicValueFormStore";
import {
  ListItem
} from "@/core/types/entities/iron-lake/equipment/characteristic-value/ListItem";
import {
  PropType,
  defineProps,
  defineEmits,
...
const listStore = useCharacteristicValueListStore();
