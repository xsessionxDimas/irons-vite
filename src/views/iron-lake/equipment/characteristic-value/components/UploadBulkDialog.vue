<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataCharacteristicValue.xlsx" target="_blank" id="link-download">here</a>
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/equipment/characteristic-value/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-lake/equipment/characteristic-value/BulkItem";
...
const handleDownload = () => {
  ...
  const data = bulkStore.validatedData.map((val) => {
    return {
      ...
      characteristicValueDescription: val.characteristicValueDescription,
  ...
  handleDataToExcel("Characteristic Value", columns, data);
}
