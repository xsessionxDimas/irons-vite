...
import {
  useCharacteristicValueBulkStore
} from "@/store/pinia/iron-lake/equipment/characteristic-value/useCharacteristicValueBulkStore";
import {
...
const bulkStore = useCharacteristicValueBulkStore();
...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Characteristic Value", [
    {
      pageName: "Iron Lake",
      pageRoute: "ironlake",
    },
    {
      pageName: "Equipment",
      pageRoute: "characteristicvalue",
    },
    {
      pageName: "Characteristic Value",
      pageRoute: "characteristicvalue",
    },
  ]);
  listStore.setPage(1);
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `CharacteristicValue.xlsx`);
}
