<template>
    ...
    <template v-else>
        ...
        :empty-text="'No Data'">
            ...
            <el-table-column prop="systemStatus" label="System Status" width="100" sortable :sort-method="(a, b) => customSort(a, b, 'systemStatus')" />
            <el-table-column prop="status" label="Status" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'status')" />
            <el-table-column prop="subStatus" label="Sub Status" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'subStatus')" />
