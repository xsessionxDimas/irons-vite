<template>
    ...
    :empty-text="'No Data'">
        ...
        <el-table-column prop="systemStatus" label="System Status" width="100" sortable />
        <el-table-column prop="status" label="Status" min-width="170" sortable />
        <el-table-column prop="subStatus" label="Sub Status" width="170" sortable/>
