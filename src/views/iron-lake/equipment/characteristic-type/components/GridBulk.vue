<template>
  ...
  >
    ...
    <el-table-column prop="characteristicType" label="Characteristic Type" width="300" sortable />
    <el-table-column prop="characteristicTypeDescription" label="Characteristic Type Description" width="300" sortable />
