<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataCharacteristicType.xlsx" target="_blank" id="link-download">here</a>
...
import {
  useCharacteristicTypeBulkStore
} from "@/store/pinia/iron-lake/equipment/characteristic-type/useCharacteristicTypeBulkStore";
import {
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/equipment/characteristic-type/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-lake/equipment/characteristic-type/BulkItem";
...
const bulkStore = useCharacteristicTypeBulkStore();
...
const handleDownload = () => {
  ...
  const data = bulkStore.validatedData.map((val) => {
    return {
      ...
      characteristicTypeDescription: val.characteristicTypeDescription,
  ...
  handleDataToExcel("Characteristic Type", columns, data);
}
