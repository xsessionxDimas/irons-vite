...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Characteristic Type", [
    {
      pageName: "Iron Lake",
      pageRoute: "ironlake",
    },
    {
      pageName: "Equipment",
      pageRoute: "CharacteristicType",
    },
    {
      pageName: "Characteristic Type",
      pageRoute: "CharacteristicType",
    },
  ]);
  listStore.setPage(1);
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `CharacteristicType.xlsx`);
}
