<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="characteristicType" label="Characteristic Type" width="250" sortable :sort-method="(a, b) => customSort(a, b, 'characteristicType')" />
          <el-table-column prop="characteristicValue" label="Characteristic Value" min-width="250" sortable :sort-method="(a, b) => customSort(a, b, 'characteristicValue')"/>
