<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataCharacteristicTypeValue.xlsx" target="_blank" id="link-download">here</a>
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/equipment/characteristic-type-value/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-lake/equipment/characteristic-type-value/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("Characteristic Type Value", columns, data);
}
