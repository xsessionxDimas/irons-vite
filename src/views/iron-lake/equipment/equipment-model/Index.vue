...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Equipment Model", [
    {
      pageName: "Iron Lake",
      pageRoute: "ironlake",
    },
    {
      pageName: "Equipment",
      pageRoute: "equipmentmodel",
    },
    {
      pageName: "Equipment Model",
      pageRoute: "equipmentmodel",
    },
  ]);
  listStore.setPage(1);
  await listStore.getLookup();
  await listStore.getBrandOptions();
});
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `Equipment Model.xlsx`);
}
