...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Component Assignment", [
    {
      pageName: "Iron Lake",
      pageRoute: "ironlake",
    },
    {
      pageName: "Equipment",
      pageRoute: "componentassignment",
    },
    {
      pageName: "Component Assignment",
      pageRoute: "componentassignment",
    },
  ]);
  listStore.setPage(1);
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `ComponentAssignment.xlsx`);
}
