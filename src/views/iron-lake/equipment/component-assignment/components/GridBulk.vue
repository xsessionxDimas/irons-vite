<template>
    ...
    :empty-text="'No Data'">
        ...
        <el-table-column prop="componentType" label="Component Type" width="170" sortable />
        <el-table-column prop="component" label="Component" width="170" sortable />
        <el-table-column prop="equipment" label="Equipment" min-width="170" sortable />
        ...
        <el-table-column prop="validationReason" label="Remark" width="100" sortable />
