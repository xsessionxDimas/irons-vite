<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="componentType" label="Component Type" width="200" sortable :sort-method="(a, b) => customSort(a, b, 'componentType')"/>
          <el-table-column prop="component" label="Component" width="200" sortable :sort-method="(a, b) => customSort(a, b, 'component')" />
          <el-table-column prop="equipment" label="Equipment" width="200" sortable :sort-method="(a, b) => customSort(a, b, 'equipment')"/>
          <el-table-column prop="objectType" label="Object Type" width="200" sortable :sort-method="(a, b) => customSort(a, b, 'objectType')"/>
          ...
          <el-table-column prop="changedBy" label="Changed by" sortable width="200" :sort-method="(a, b) => customSort(a, b, 'changedBy')" />
...
import { formatDateOnlyAU, formatDateAU } from "@/core/helpers/date-format";
import {
