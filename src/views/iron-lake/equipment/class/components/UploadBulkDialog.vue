<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataClass.xlsx" target="_blank" id="link-download">here</a>
...
import {
  useClassBulkStore
} from "@/store/pinia/iron-lake/equipment/class/useClassBulkStore";
import {
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/equipment/class/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-lake/equipment/class/BulkItem";
...
const bulkStore = useClassBulkStore();
...
const handleDownload = () => {
  ...
  handleDataToExcel("Class", columns, data);
}
