<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="classDescription" label="Class Description" min-width="300" sortable :sort-method="(a, b) => customSort(a, b, 'classDescription')" />
...
import {
  useClassListStore
} from "@/store/pinia/iron-lake/equipment/class/useClassListStore";
import {
  useClassFormStore
...
const listStore = useClassListStore();
