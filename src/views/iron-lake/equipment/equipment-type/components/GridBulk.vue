<template>
    ...
    :empty-text="'No Data'">
        ...
        <el-table-column prop="equipmentType" label="Equipment Type" width="300" sortable />
        <el-table-column prop="equipmentTypeDescription" label="Equipment Type Desc." sortable />
