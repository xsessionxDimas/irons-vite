<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataOwner.xlsx" target="_blank" id="link-download">here</a>
...
import {
  useOwnerBulkStore
} from "@/store/pinia/iron-lake/business-partner/owner/useOwnerBulkStore";
import {
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/business-partner/owner/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-lake/business-partner/owner/BulkItem";
...
const bulkStore = useOwnerBulkStore();
...
const handleDownload = () => {
  ...
  handleDataToExcel("Owner", columns, data);
}
