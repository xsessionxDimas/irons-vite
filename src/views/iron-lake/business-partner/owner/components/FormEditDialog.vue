  ...
  >
    ...
    <Form id="kt_filter_form" class="row g-9 my-4">
      <AutoComplete
        ...
        :options="formStore.companyOption"
        @handle-change="handleOwnerChange" />
...
const inputValidation = Yup.object().shape({
  Owner: Yup.string().required("Owner is mandatory"),
