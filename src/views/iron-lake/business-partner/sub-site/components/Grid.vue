<template>
    ...
    <template v-else>
        ...
        :empty-text="'No Data'">
            ...
            <el-table-column prop="subSite" label="Sub Site" width="100" sortable :sort-method="(a, b) => customSort(a, b, 'subSite')" />
            <el-table-column prop="subSiteDescription" label="Sub Site Desc." sortable :sort-method="(a, b) => customSort(a, b, 'subSiteDescription')"/>
            ...
            <el-table-column prop="changedBy" label="Changed by" wdith="300" sortable :sort-method="(a, b) => customSort(a, b, 'changedBy')" />
