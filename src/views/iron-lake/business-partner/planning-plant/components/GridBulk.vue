<template>
  ...
  >
    ...
    <el-table-column prop="planningPlantId" label="Planning Plant ID" width="170" sortable />
    <el-table-column prop="planningPlantCode" label="Planning Plant Code" width="170" sortable />
    <el-table-column prop="planningPlantDescription" label="Planning Plant Desc." sortable />
