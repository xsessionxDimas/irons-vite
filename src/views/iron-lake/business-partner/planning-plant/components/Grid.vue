<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="planningPlantId" label="Planning Plant ID" width="150" sortable :sort-method="(a, b) => customSort(a, b, 'planningPlantId')" />
      <el-table-column prop="planningPlantCode" label="Planning Plant Code" width="200" sortable :sort-method="(a, b) => customSort(a, b, 'planningPlantCode')" />
      <el-table-column prop="planningPlantDescription" label="Planning Plant Desc." min-width="200" sortable :sort-method="(a, b) => customSort(a, b, 'planningPlantDescription')" />
      <el-table-column prop="startDate" label="Start Date" align="center" width="120" sortable>
        <template #default="scope">
          <span>{{ formatDateOnlyAU(scope.row.startDate) }}</span>
        </template>
      </el-table-column>
      <el-table-column prop="endDate" label="End Date" align="center" width="100" sortable>
        <template #default="scope">
      ...
      <el-table-column prop="changedBy" label="Changed by" sortable  width="300" :sort-method="(a, b) => customSort(a, b, 'changeBy')" />
