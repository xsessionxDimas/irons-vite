        ...
        <Form id="kt_filter_form" class="row g-9 my-4">
          <div class="row g-4 my-4">
            <div class="col-md-6 fv-row fv-plugins-icon-container">
              ...
              label="Brand Name"
              name="brand"
              @handle-change="handleBrandNameChange" />
            </div>
            <div class="col-md-6 fv-row fv-plugins-icon-container">
              <TextInput
              ...
              @handle-change="handleBrandDescriptionChange" />
            </div>
            <div class="col-md-6 fv-row fv-plugins-icon-container">
              <DatePickerInput
...
const inputValidation = Yup.object().shape({
  ...
  brandDescription: Yup.string().required("Brand Description is mandatory"),
...
const handleBrandDescriptionChange = (value: string) => {
  formData.value.brandDescription = value
}
