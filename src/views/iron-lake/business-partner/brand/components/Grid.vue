<template>
  ...
  <template v-else>
    ...
    :empty-text="'No Data'">
        ...
        <el-table-column prop="brand" label="Brand" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'brand')" />
        <el-table-column prop="brandDescription" label="Brand Desc" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'brandDescription')" />
...
import {
  useBrandFormStore
} from "@/store/pinia/iron-lake/business-partner/brand/useBrandFormStore";
import {
  formatDateAU,
  formatDateOnlyAU
...
const formStore = useBrandFormStore();
