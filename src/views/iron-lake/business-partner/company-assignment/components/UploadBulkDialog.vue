<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataCompanyAssignment.xlsx" target="_blank" id="link-download">here</a>
...
import {
  useCompanyAssignmentBulkStore
} from "@/store/pinia/iron-lake/business-partner/company-assignment/useCompanyAssignmentBulkStore";
import {
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/business-partner/company-assignment/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-lake/business-partner/company-assignment/BulkItem";
...
const bulkStore = useCompanyAssignmentBulkStore();
...
const handleDownload = () => {
  ...
  handleDataToExcel("Company Assignment", columns, data);
}
