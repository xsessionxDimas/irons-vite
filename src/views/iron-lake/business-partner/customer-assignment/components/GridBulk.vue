<template>
    ...
    :empty-text="'No Data'">
        ...
        <el-table-column prop="maintenancePlantDescription" label="Maintenance Plant Desc." min-width="170" sortable />
        <el-table-column prop="customer" label="Customer" width="150" sortable />
        <el-table-column prop="customerDescription" label="Customer Desc." min-width="170" sortable />
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/business-partner/customer-assignment/ValidatedItem";
import {
