<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataCustomerAssignment.xlsx" target="_blank" id="link-download">here</a>
...
import {
  BulkItem
} from "@/core/types/entities/iron-lake/business-partner/customer-assignment/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("Customer Assignment", columns, data);
}
