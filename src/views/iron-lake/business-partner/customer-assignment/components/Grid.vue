<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="maintenancePlantDescription" label="Maintenance Plant Desc." min-width="220" sortable :sort-method="(a, b) => customSort(a, b, 'maintenancePlantDescription')" />
          <el-table-column prop="customer" label="Customer" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'customer')" />
