<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataSite.xlsx" target="_blank" id="link-download">here</a>
...
import {
  BulkItem
} from "@/core/types/entities/iron-lake/business-partner/site-v1/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("Site", columns, data);
}
