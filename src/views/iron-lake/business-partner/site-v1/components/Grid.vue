<template>
    ...
    <template v-else>
        ...
        :empty-text="'No Data'">
            ...
            <el-table-column prop="SiteId" label="Site ID" width="100" sortable :sort-method="(a, b) => customSort(a, b, 'SiteId')" />
            <el-table-column prop="SiteCode" label="Site Code" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'SiteCode')"/>
            <el-table-column prop="SiteDescription" label="Site Desc." min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'SiteDescription')"/>
