<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataCustomer.xlsx" target="_blank" id="link-download">here</a>
...
import {
  useCustomerBulkStore
} from "@/store/pinia/iron-lake/business-partner/customer/useCustomerBulkStore";
import {
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/business-partner/customer/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-lake/business-partner/customer/BulkItem";
...
const bulkStore = useCustomerBulkStore();
...
const handleDownload = () => {
  ...
  handleDataToExcel("Customer", columns, data);
}
