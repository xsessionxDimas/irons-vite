<template>
    ...
    <template v-else>
        ...
        class="fixed-height-table">
            ...
            <el-table-column prop="maintenancePlantId" label="Maintenance Plant ID" width="200" sortable :sort-method="(a, b) => customSort(a, b, 'maintenancePlantId')" />
            <el-table-column prop="maintenancePlantCode" label="Maintenance Plant Code" width="200" sortable :sort-method="(a, b) => customSort(a, b, 'maintenancePlantCode')"/>
            <el-table-column prop="maintenancePlantDescription" label="Maintenance Plant Desc." width="200" sortable :sort-method="(a, b) => customSort(a, b, 'maintenancePlantDescription')"/>
            ...
            <el-table-column prop="changedOn" label="Changed on" width="170" sortable>
                <template #default="scope">
                    <span>{{ formatDateAU(scope.row.changedOn) }}</span>
                </template>
            </el-table-column>
            <el-table-column prop="changedBy" label="Changed by" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'changedBy')"/>
