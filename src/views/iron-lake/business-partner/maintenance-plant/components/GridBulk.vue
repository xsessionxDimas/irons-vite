<template>
    ...
    :empty-text="'No Data'">
        ...
        <el-table-column prop="maintenancePlantId" label="Maintenance Plant ID" width="170" sortable />
        <el-table-column prop="maintenancePlantCode" label="Maintenance Plant Code" width="170" sortable />
        <el-table-column prop="maintenancePlantDescription" label="Maintenance Plant Desc." width="170" sortable />
