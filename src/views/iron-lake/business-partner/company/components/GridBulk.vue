<template>
    ...
    :empty-text="'No Data'">
        ...
        <el-table-column prop="Company" label="Company" width="300" sortable />
        <el-table-column prop="CompanyDescription" label="Company Desc." sortable />
        ...
        <el-table-column prop="ValidationReason" label="Remark" min-widtth="300" sortable />
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/business-partner/company/ValidatedItem";
import {
  useCompanyBulkStore
} from "@/store/pinia/iron-lake/business-partner/company/useCompanyBulkStore";
...
/* stores */
const bulkStore = useCompanyBulkStore();
