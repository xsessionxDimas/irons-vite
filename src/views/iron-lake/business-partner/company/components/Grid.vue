<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="Company" label="Company" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'Company')" />
      <el-table-column prop="CompanyDescription" label="Company Desc." min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'CompanyDescription')" />
