<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="smuDue" label="SMU Due" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'smuDue')" />
          <el-table-column prop="workOrder" label="Work Order" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'workOrder')" />
          <el-table-column prop="psType" label="PsType" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'psType')" />
          ...
          <el-table-column prop="status" label="Status" width="120" sortable :sort-method="(a, b) => customSort(a, b, 'status')" />
      </el-table>
    </template>
</template>
