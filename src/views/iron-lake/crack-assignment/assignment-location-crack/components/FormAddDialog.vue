    ...
    @close="handleCloseModal()">
        ...
        <Form id="kt_filter_form" class="row g-9 my-4" v-loading="formStore.loading">
            <AutoComplete
                ...
                :options="formStore.modelFormOption"
           />
            <AutoComplete
...
const formReset = () => {
  handleModelChange("");
  handlePsTypeChange("");
  handleTaskNumberDetailParentChange("");
  handleLocationIdParentChange("");
  handleTaskNumberDetailChildChange("");
  handleLocationIdChildChange("");
