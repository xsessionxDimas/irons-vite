<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataLocationCrack.xlsx" target="_blank" id="link-download">here</a>
...
import {
  BulkItem
} from "@/core/types/entities/iron-lake/crack-assignment/location-crack/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("LocationCrack", columns, data);
}
