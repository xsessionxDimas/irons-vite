<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="EmployeeId" label="Employee ID" min-width="130" sortable :sort-method="(a, b) => customSort(a, b, 'EmployeeId')" />
          <el-table-column prop="EmployeeName" label="Name" min-width="150" sortable :sort-method="(a, b) => customSort(a, b, 'EmployeeName')"/>
          <el-table-column prop="EmployeeDirect" label="Employee ID Direct" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'EmployeeDirect')"/>
          <el-table-column prop="EmployeeDirectName" label="Employee ID Direct Name" min-width="200" sortable :sort-method="(a, b) => customSort(a, b, 'EmployeeDirectName')"/>
