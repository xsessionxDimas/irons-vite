<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="Company" label="Company" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'Company')" />
          <el-table-column prop="EmployeeId" label="Employee Id" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'EmployeeId')" />
          <el-table-column prop="Name" label="Name" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'Name')" />
          <el-table-column prop="AdAccount" label="Ad Account" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'AdAccount')" />
          <el-table-column prop="Email" label="Email" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'Email')" />
          <el-table-column prop="Phone" label="Phone" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'Phone')" />
          <el-table-column prop="Gender" label="Gender" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'Gender')" />
          <el-table-column prop="Position" label="Position" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'Position')" />
          <el-table-column prop="Location" label="Location" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'Location')" />
