<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataEmployee.xlsx" target="_blank" id="link-download">here</a>
...
import {
  BulkItem
} from "@/core/types/entities/administration/organization-unit/employee-v1/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("Employee", columns, data);
}
