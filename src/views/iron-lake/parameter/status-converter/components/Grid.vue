<template>
  ...
  <template v-else>
    ...
    :empty-text="'No Data'">
        ...
        <el-table-column prop="statusConverterDescription" label="Status Converter Desc" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'statusConverterDescription')" />
