...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Assignment Component Lubricant", [
    {
      pageName: "Iron Lake",
      pageRoute: "ironlake",
    },
    {
      pageName: "Parameter",
      pageRoute: "assignmentcomponentlubricant",
    },
    {
      pageName: "Assignment Component Lubricant",
      pageRoute: "assignmentcomponentlubricant",
    },
  ]);
  listStore.setPage(1);
  listStore.getLookup();
  formStore.getComponentLubriLookUp();
  formStore.getPsTypeLookUp();
  formStore.getEquipmentModelLookUp();
});
...
const reload = async () => {
  ...
  await formStore.getComponentLubriLookUp();
  await formStore.getPsTypeLookUp();
  await formStore.getEquipmentModelLookUp();
}
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    ...
    }), `Assignment Component Lubricant.xlsx`);
}
