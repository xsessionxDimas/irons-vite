<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="equipmentModel" label="Equipment Model" width="200" sortable :sort-method="(a, b) => customSort(a, b, 'equipmentModel')" />
          <el-table-column prop="psType" label="PS Type" width="200" sortable :sort-method="() => defaultSort()" />
          <el-table-column prop="component" label="ID Component" width="200" sortable :sort-method="(a, b) => customSort(a, b, 'component')" />
          <el-table-column prop="recomendedLubricant" label="Recommended Lubricants" width="250" sortable :sort-method="(a, b) => customSort(a, b, 'recomendedLubricant')"/>
          ...
          <el-table-column prop="taskNo" label="Task No" width="100" sortable :sort-method="(a, b) => customSort(a, b, 'taskNo')" />
