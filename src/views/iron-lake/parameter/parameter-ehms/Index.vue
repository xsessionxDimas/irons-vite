...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Parameter", [
    {
      pageName: "Iron Lake",
      pageRoute: "ironlake",
    },
  ...
  listStore.setPage(1);
  listStore.getLookup();
  listStore.getComponentLookUp();
  listStore.getModelLookUp();
  listStore.getPsTypeLookUp();
  listStore.getUomLookUp();
  listStore.getAreaCbmLookUp();
  listStore.getStatusConverterLookUp();
  listStore.getCbmParameterLookUp();
  listStore.getCbmGroupLookUp();
  listStore.getParameterLookUp();
});
