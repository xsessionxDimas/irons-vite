<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataCbmGroup.xlsx" target="_blank" id="link-download">here</a>
...
import {
  useCbmGroupBulkStore
} from "@/store/pinia/iron-lake/parameter/cbm-group/useCbmGroupBulkStore";
import {
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/parameter/cbm-group/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-lake/parameter/cbm-group/BulkItem";
...
const bulkStore = useCbmGroupBulkStore();
...
const handleDownload = () => {
  ...
  handleDataToExcel("CbmGroup", columns, data);
}
