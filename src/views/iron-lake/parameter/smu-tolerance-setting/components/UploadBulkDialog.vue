<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataSmuToleranceSetting.xlsx" target="_blank" id="link-download">here</a>
...
import {
  useSmuToleranceSettingBulkStore
} from "@/store/pinia/iron-lake/parameter/smu-tolerance-setting/useSmuToleranceSettingBulkStore";
import {
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/parameter/smu-tolerance-setting/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-lake/parameter/smu-tolerance-setting/BulkItem";
...
const bulkStore = useSmuToleranceSettingBulkStore();
...
const handleDownload = () => {
  ...
  handleDataToExcel("SmuToleranceSetting", columns, data);
}
