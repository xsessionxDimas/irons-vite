<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="parameter" label="Parameter" width="200" sortable :sort-method="(a, b) => customSort(a, b, 'parameter')" />
          <el-table-column prop="valueMin" label="Value Min" width="110" sortable :sort-method="(a, b) => customSort(a, b, 'valueMin')"/>
          <el-table-column prop="valueMax" label="Value Max" width="110" sortable :sort-method="(a, b) => customSort(a, b, 'valueMax')" />
