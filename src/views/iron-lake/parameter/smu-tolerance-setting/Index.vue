...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("SMU Tolerance Setting", [
    {
      pageName: "Iron Lake",
      pageRoute: "ironlake",
    },
    {
      pageName: "Parameter",
      pageRoute: "smutolerancesetting",
    },
    {
      pageName: "SMU Tolerance Setting",
      pageRoute: "smutolerancesetting",
    },
  ]);
  listStore.setPage(1);
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `SMU Tolerance Setting.xlsx`);
}
