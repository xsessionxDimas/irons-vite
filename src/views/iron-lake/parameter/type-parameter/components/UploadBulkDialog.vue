<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataTypeParameter.xlsx" target="_blank" id="link-download">here</a>
...
import {
  BulkItem
} from "@/core/types/entities/iron-lake/parameter/type-parameter/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("TypeParameter", columns, data);
}
