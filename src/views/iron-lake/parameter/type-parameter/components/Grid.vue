<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="idParameter" label="ID Parameter" width="150" sortable :sort-method="(a, b) => customSort(a, b, 'idParameter')" />
          <el-table-column prop="parameter" label="Parameter" min-width="200" sortable :sort-method="(a, b) => customSort(a, b, 'parameter')" />
