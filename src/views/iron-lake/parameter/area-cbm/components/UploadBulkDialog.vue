<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataAreaCbm.xlsx" target="_blank" id="link-download">here</a>
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/parameter/area-cbm/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-lake/parameter/area-cbm/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("AreaCbm", columns, data);
}
