<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataUom.xlsx" target="_blank" id="link-download">here</a>
...
import {
  useUomBulkStore
} from "@/store/pinia/iron-lake/parameter/uom/useUomBulkStore";
import {
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/parameter/uom/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-lake/parameter/uom/BulkItem";
...
const bulkStore = useUomBulkStore();
...
const handleDownload = () => {
  ...
  handleDataToExcel("Master Data Uom", columns, data);
}
