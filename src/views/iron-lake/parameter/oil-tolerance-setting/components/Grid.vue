<template>
  ...
  <template v-else>
    ...
    :empty-text="'No Data'">
        ...
        <el-table-column prop="value" label="Value" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'value')" />
        <el-table-column prop="valueMin" label="Value Min" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'valueMin')" />
        <el-table-column prop="valueMax" label="Value Max" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'valueMax')" />
