<template>
  ...
  <template v-else>
    ...
    :empty-text="'No Data'">
        ...
        <el-table-column prop="mdCbmParameterId" label="ID CBM Parameter" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'mdCbmParameterId')" />
        <el-table-column prop="cbmParameterName" label="CBM Parameter" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'cbmParameterName')" />
...
} from "@/store/pinia/iron-lake/parameter/cbm-parameter/useCbmParameterFormStore";
import {
  formatDateAU,
  formatDateOnlyAU
