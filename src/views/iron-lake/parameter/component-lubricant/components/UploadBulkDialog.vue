<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataComponentLubricant.xlsx" target="_blank" id="link-download">here</a>
...
import {
  BulkItem
} from "@/core/types/entities/iron-lake/parameter/component-lubricant/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("ComponentLubricant", columns, data);
}
