<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataPlannedDuration.xlsx" target="_blank" id="link-download">here</a>
...
import {
  usePlannedDurationBulkStore
} from "@/store/pinia/iron-lake/parameter/planned-duration/usePlannedDurationBulkStore";
import {
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-lake/parameter/planned-duration/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-lake/parameter/planned-duration/BulkItem";
...
const bulkStore = usePlannedDurationBulkStore();
...
const handleDownload = () => {
  ...
  handleDataToExcel("PlannedDuration", columns, data);
}
