...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Planned Duration", [
    {
      pageName: "Iron Lake",
      pageRoute: "ironlake",
    },
    {
      pageName: "Parameter",
      pageRoute: "plannedduration",
    },
    {
      pageName: "Planned Duration",
      pageRoute: "plannedduration",
    },
  ]);
  listStore.setPage(1);
  listStore.getLookup();
  formStore.getUomLookUp();
  formStore.getPsTypeLookUp();
  formStore.getModelLookUp();
});
...
const reload = async () => {
  ...
  await formStore.getUomLookUp();
  await formStore.getPsTypeLookUp();
  await formStore.getModelLookUp();
}
