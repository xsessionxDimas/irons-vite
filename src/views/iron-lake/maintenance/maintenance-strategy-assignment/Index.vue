...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Maintenance Strategy Assignment", [
    {
      pageName: "Iron Lake",
      pageRoute: "ironlake",
    },
    {
      ...
      pageRoute: "maintenancestrategyassignment",
    },
    {
      pageName: "Maintenance Strategy Assignment",
      pageRoute: "maintenancestrategyassignment",
    },
  ]);
  listStore.setPage(1);
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    ...
    }), `Master Data Maintenance Strategy Assignment.xlsx`);
}
