<template>
    ...
    <template v-else>
      ...
      :empty-text="'No Data'">
          ...
          <el-table-column prop="maintenanceStrategyParId" label="ID Maintenance Strategy Parent" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'maintenanceStrategyParId')" />
          <el-table-column prop="maintenanceStrategyChdId" label="ID Maintenance Strategy Child" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'maintenanceStrategyChdId')" />
