<template>
    ...
    :empty-text="'No Data'">
          ...
          <el-table-column prop="maintenanceStrategyParId" label="ID Maintenance Strategy Parent" width="170" sortable />
          <el-table-column prop="maintenanceStrategyChdId" label="ID Maintenance Strategy Child" width="170" sortable />
