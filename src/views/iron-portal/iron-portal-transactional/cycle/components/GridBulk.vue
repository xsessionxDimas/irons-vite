<template>
  ...
  >
    ...
    <el-table-column prop="equipmentModel" label="Model" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'equipmentModel')" />
    <el-table-column prop="equipmentNumber" label="Equipment" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'equipmentNumber')" />
    <el-table-column prop="component" label="Component" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'component')" />
    <el-table-column prop="hoCycleTarget" label="Ho Cycle Target" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'hoCycleTarget')" />
    <el-table-column prop="siteCycleTarget" label="Site Cycle Target" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'siteCycleTarget')" />
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-portal/iron-portal-transactional/cycle/ValidatedItem";
import {
  useCycleBulkStore
