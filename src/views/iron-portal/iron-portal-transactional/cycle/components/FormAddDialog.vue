...
<template>
  ...
  >
    ...
    <Form id="kt_filter_form" class="row g-9 my-4"  v-loading="formStore.loading">
      ...
      <DecimalInput
        :value="formData.hoCycleTarget"
        placeholder="Add Ho Cycle Target"
        label="Ho Cycle Target"
        name="hoCycleTarget"
        @handleChange="handleHoCycleTargetChange" />
      <DecimalInput
        :value="formData.siteCycleTarget"
        placeholder="Add Site Cycle Target"
        label="Site Cycle Target"
        name="siteCycleTarget"
        @handleChange="handleSiteCycleTargetChange" />
...
const handleHoCycleTargetChange = (value: string) => {
  formData.value.hoCycleTarget = value;
};
const handleSiteCycleTargetChange = (value: string) => {
  formData.value.siteCycleTarget = value;
};
