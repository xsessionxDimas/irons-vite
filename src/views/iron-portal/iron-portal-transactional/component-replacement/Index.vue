...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Component Replacement", [
    {
      pageName: "IronPortal",
    ...
    },
    {
      ...
      pageRoute: "componentreplacement",
    },
    {
      pageName: "Component Replacement",
      pageRoute: "componentreplacement",
    },
  ]);
  listStore.setPage(1);
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `ComponentReplacement.xlsx`);
}
