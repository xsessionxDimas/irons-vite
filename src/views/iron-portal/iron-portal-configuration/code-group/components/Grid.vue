<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="CodeGroup" label="Code Group" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'CodeGroup')" />
      <el-table-column prop="CodeGroupDescription" label="Code Group Description" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'CodeGroupDescription')" />
