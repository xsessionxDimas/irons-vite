<template>
  ...
  >
    ...
    <el-table-column prop="CodeGroupDescription" label="Code Group Description" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'CodeGroupDescription')" />
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/code-group/ValidatedItem";
import {
