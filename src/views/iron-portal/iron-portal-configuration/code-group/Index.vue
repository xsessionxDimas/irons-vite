...
import {
  useCodeGroupListStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/code-group/useCodeGroupListStore";
import {
  useCodeGroupBulkStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/code-group/useCodeGroupBulkStore";
import {
...
const listStore = useCodeGroupListStore();
const formStore = useCodeGroupFormStore();
const bulkStore = useCodeGroupBulkStore();
...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Code Group", [
    {
    ...
    },
    {
      ...
      pageRoute: "ironlake-config-codegroup",
    },
    {
      pageName: "Code Group",
      pageRoute: "ironlake-config-codegroup",
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `CodeGroup.xlsx`);
}
