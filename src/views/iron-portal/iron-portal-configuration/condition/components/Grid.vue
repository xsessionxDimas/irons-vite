<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="Condition" label="Condition" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="ConditionDescription" label="Condition Description" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
