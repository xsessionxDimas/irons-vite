<template>
  ...
  >
    ...
    <el-table-column prop="Condition" label="Condition" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'Condition')" />
    <el-table-column prop="ConditionDescription" label="Condition Description" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'ConditionDescription')" />
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/condition/ValidatedItem";
import {
  useConditionBulkStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/condition/useConditionBulkStore";
import {
  PropType,
  defineProps,
  computed,
...
/* stores */
const bulkStore = useConditionBulkStore();
