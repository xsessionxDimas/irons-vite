...
} from "../../../../store/pinia/iron-portal/iron-portal-configuration/condition/useConditionListStore";
import {
...
const listStore = useConditionListStore();
...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Condition", [
    {
    ...
    },
    {
      ...
      pageRoute: "ironlake-config-condition",
    },
    {
      pageName: "Condition",
      pageRoute: "ironlake-config-condition",
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `Condition.xlsx`);
}
