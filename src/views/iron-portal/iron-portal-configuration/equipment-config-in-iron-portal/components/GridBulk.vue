<template>
  ...
  >
    ...
    <el-table-column prop="codeGroup" label="Code Group" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'codeGroup')" />
    <el-table-column prop="damageCategory" label="Damage Category" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'damageCategory')" />
    <el-table-column prop="damage" label="Damage" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'damage')" />
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/equipment-config-in-iron-portal/ValidatedItem";
import {
  useEquipmentConfigInIronPortalBulkStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/equipment-config-in-iron-portal/useEquipmentConfigInIronPortalBulkStore";
import {
  PropType,
  defineProps,
  computed,
...
/* stores */
const bulkStore = useEquipmentConfigInIronPortalBulkStore();
