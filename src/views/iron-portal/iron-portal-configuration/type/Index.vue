...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("CBM Parameter Name", [
    {
    ...
    },
    {
      ...
      pageRoute: "ironlake-config-type",
    },
    {
      pageName: "CBM Parameter Name",
      pageRoute: "ironlake-config-type",
    },
  ]);
  listStore.setPage(1);
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `CBMParameterName.xlsx`);
}
