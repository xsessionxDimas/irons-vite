<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
        Download template
        <a href="documents/MasterDataCbmParameterName.xlsx" target="_blank" id="link-download">here</a>
...
import {
  BulkItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/type/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("CBMParameterName", columns, data);
}
