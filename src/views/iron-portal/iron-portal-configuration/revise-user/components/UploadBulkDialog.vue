<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataReviseUser.xlsx" target="_blank" id="link-download">here</a>
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/revise-user/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/revise-user/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("ReviseUser", columns, data);
}
