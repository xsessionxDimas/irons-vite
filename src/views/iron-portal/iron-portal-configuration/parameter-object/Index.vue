...
import {
  useParameterObjectBulkStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/parameter-object/useParameterObjectBulkStore";
import {
...
const bulkStore = useParameterObjectBulkStore();
...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Parameter Object", [
    {
    ...
    },
    {
      ...
      pageRoute: "ironlake-config-parameterobject",
    },
    {
      pageName: "Parameter Object",
      pageRoute: "ironlake-config-parameterobject",
    },
  ]);
  listStore.setPage(1);
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `ParameterObject.xlsx`);
}
