<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="ParameterObject" label="Parameter Object" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'ParameterObject')" />
      <el-table-column prop="ParameterObjectDescription" label="Parameter Object Description" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'ParameterObjectDescription')" />
...
import {
  useParameterObjectListStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/parameter-object/useParameterObjectListStore";
import {
...
const listStore = useParameterObjectListStore();
