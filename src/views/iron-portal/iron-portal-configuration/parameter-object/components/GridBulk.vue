<template>
  ...
  >
    ...
    <el-table-column prop="ParameterObject" label="ParameterObject" width="300" sortable />
    <el-table-column prop="ParameterObjectDescription" label="ParameterObject Description" width="300" sortable />
