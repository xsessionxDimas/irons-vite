...
const handleSort = (sort) => {
  ...
  listStore.setSortSpecific(payload);
}
...
const handleEditRow = async (item: ListItemSpecific) => {
...
const assignEditItem = (item: ListItemSpecific): UpsertItem => {
  return {
...
const handleDuplicateRow = async (dataRow: ListItemSpecific) => {
  console.log(dataRow)
