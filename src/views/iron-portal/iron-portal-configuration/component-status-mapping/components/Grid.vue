<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="ComponentStatusId" label="Component Status ID" min-width="190" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="CbmGroup" label="CBM Group" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="Rating" label="Rating" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
