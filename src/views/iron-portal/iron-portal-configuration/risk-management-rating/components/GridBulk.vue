<template>
  ...
  >
    ...
    <el-table-column prop="ratingParameter" label="Rating Parameter" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'ratingParameter')" />
    <el-table-column prop="ratingCode" label="Rating Code" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'ratingCode')" />
    <el-table-column prop="ratingDescription" label="Rating Description" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'ratingDescription')" />
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/risk-management-rating/ValidatedItem";
import {
