<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataCbmAreaMapping.xlsx" target="_blank" id="link-download">here</a>
...
import {
  BulkItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/cbm-area-mapping/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("CbmAreaMapping", columns, data);
}
