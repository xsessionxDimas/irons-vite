<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="ObjectType" label="Object Type" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'ObjectType')" />
      <el-table-column prop="CbmGroup" label="Cbm Group" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'CbmGroup')" />
      <el-table-column prop="Area" label="Area" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'Area')" />
