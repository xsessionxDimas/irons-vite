<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="Item" label="Item" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="ItemDescription" label="Item Description" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
...
import {
  useItemFormStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/item/useItemFormStore";
import {
  ListItem
...
const formStore = useItemFormStore();
