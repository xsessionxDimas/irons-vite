<template>
  ...
  >
    ...
    <el-table-column prop="Item" label="Item" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'Item')" />
    <el-table-column prop="ItemDescription" label="Item Description" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'ItemDescription')" />
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/item/ValidatedItem";
import {
  useItemBulkStore
