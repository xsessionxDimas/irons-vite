...
import {
  useItemBulkStore
} from "../../../../store/pinia/iron-portal/iron-portal-configuration/item/useItemBulkStore";
import {
  useItemFormStore
...
const bulkStore = useItemBulkStore();
...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Item", [
    {
    ...
    },
    {
      ...
      pageRoute: "ironlake-config-item",
    },
    {
      pageName: "Item",
      pageRoute: "ironlake-config-item",
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `Item.xlsx`);
}
