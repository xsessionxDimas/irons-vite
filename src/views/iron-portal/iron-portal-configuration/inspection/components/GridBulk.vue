<template>
  ...
  >
    ...
    <el-table-column prop="Inspection" label="Inspection" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'Inspection')" />
    <el-table-column prop="InspectionDescription" label="Inspection Description" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'InspectionDescription')" />
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/inspection/ValidatedItem";
import {
  useInspectionBulkStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/inspection/useInspectionBulkStore";
import {
  PropType,
  defineProps,
  computed,
...
/* stores */
const bulkStore = useInspectionBulkStore();
