  ...
  >
    ...
    <Form id="kt_filter_form" class="row g-9 my-4"  v-loading="formStore.loading">
      <TextInput
        ...
        name="Inspection"
        :max="20"
        @handleChange="handleInspectionChange" />
      <TextInput
        :value="formData.inspectionDescription"
        :margin="false"
        placeholder="Add Inspection Description"
        label="Inspection Description"
        name="InspectionDescription"
        :max="40"
        @handleChange="handleInspectionDescriptionChange" />
...
import {
  UpsertItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/inspection/UpsertItem";
...
const inputValidation = Yup.object().shape({
  inspection: Yup.string().required("Inspection is mandatory"),
  inspectionDescription: Yup.string().required("Inspection Description is mandatory"),
...
const formReset = () => {
  ...
  handleInspectionDescriptionChange("");
...
const handleInspectionChange = (value: string) => {
  formData.value.inspection = value;
};
const handleInspectionDescriptionChange = (value: string) => {
  formData.value.inspectionDescription = value;
};
