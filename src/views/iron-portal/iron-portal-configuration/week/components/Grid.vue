<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="Week" label="Week" min-width="170" sortable :sort-method="defaultSorting(columnOrder)" />
      <el-table-column prop="WeekDescription" label="Week Description" min-width="170" sortable :sort-method="defaultSorting(columnOrder)" />
...
import {
  useWeekListStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/week/useWeekListStore";
import {
  useWeekFormStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/week/useWeekFormStore";
import {
  ListItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/week/ListItem";
import {
  PropType,
  defineProps,
  defineEmits,
...
const listStore = useWeekListStore();
const formStore = useWeekFormStore();
