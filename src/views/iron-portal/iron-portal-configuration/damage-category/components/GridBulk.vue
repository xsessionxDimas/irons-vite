<template>
  ...
  >
    ...
    <el-table-column prop="DamageCategory" label="Damage Category" width="300" sortable />
    <el-table-column prop="DamageCategoryDescription" label="Damage Category Description" width="300" sortable />
