<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="DamageCategory" label="Damage Category" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'DamageCategory')" />
      <el-table-column prop="DamageCategoryDescription" label="Damage Category Description" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'DamageCategoryDescription')" />
...
import {
  useDamageCategoryFormStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/damage-category/useDamageCategoryFormStore";
import {
  ListItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/damage-category/ListItem";
import {
  PropType,
  defineProps,
  defineEmits,
...
const formStore = useDamageCategoryFormStore();
