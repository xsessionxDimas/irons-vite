...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Damage Category", [
    {
    ...
    },
    {
      ...
      pageRoute: "ironlake-config-damage-category",
    },
    {
      pageName: "Damage Category",
      pageRoute: "ironlake-config-damage-category",
    },
  ]);
  listStore.setPage(1);
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `DamageCategory.xlsx`);
}
