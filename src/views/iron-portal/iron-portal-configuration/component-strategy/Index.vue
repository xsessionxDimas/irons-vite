...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Component Strategy", [
    {
    ...
    },
    {
      ...
      pageRoute: "ironlake-config-componentstrategy",
    },
    {
      pageName: "Component Strategy",
      pageRoute: "ironlake-config-componentstrategy",
    },
  ]);
  listStore.setPage(1);
  await listStore.getLookup();
  await formStore.getLookupComponentCode();
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `ComponentStrategy.xlsx`);
}
