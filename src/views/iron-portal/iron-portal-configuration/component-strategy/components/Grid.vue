<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="ComponentCode" label="Component Code" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="EquipmentModel" label="Equipment Model" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="ModifierCode" label="Modifier Code" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="TaskType" label="Task Type" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="StrategyTaskDesc" label="Strategy Task Description" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="OemInterval" label="Oem Interval" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="PercentageOfOem" label="% 0f Oem" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
