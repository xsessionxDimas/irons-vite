<template>
  ...
  >
    ...
    <el-table-column prop="Rating" label="Rating" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'Rating')" />
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/rating/ValidatedItem";
import {
  useRatingBulkStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/rating/useRatingBulkStore";
import {
  PropType,
  defineProps,
  computed,
...
/* stores */
const bulkStore = useRatingBulkStore();
