<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataAction.xlsx" target="_blank" id="link-download">here</a>
...
import {
  BulkItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/action/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("Action", columns, data);
}
