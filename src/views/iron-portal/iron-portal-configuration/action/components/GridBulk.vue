<template>
  ...
  >
    ...
    <el-table-column prop="Action" label="Action" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'Action')" />
    <el-table-column prop="ActionDescription" label="Action Description" width="300" sortable :sort-method="(a, b) => customSort(a, b, 'ActionDescription')" />
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/action/ValidatedItem";
import {
  useActionBulkStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/action/useActionBulkStore";
import {
  PropType,
  defineProps,
  computed,
...
/* stores */
const bulkStore = useActionBulkStore();
