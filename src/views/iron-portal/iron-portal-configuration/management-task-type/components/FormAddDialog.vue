  ...
  >
    ...
    <Form id="kt_filter_form" class="row g-9 my-4" v-loading="formStore.loading">
      <ElementTextInput
        ...
        name="TaskTypeCode"
        :max="10"
        @handleChange="handleTaskTypeCodeChange" />
      <ElementTextInput
        :value="formData.taskTypeDescription"
        placeholder="Add Type Description"
        label="Type Description"
        name="TypeDescription"
        :max="80"
        @handleChange="handleTaskTypeDescriptionChange" />
...
const handleTaskTypeCodeChange = (value: string) => {
  formData.value.taskTypeCode = value;
};
const handleTaskTypeDescriptionChange = (value: string) => {
  formData.value.taskTypeDescription = value;
};
