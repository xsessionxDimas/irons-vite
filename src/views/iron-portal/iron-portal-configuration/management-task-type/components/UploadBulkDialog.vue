<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataManagementTaskType.xlsx" target="_blank" id="link-download">here</a>
...
import {
  BulkItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/management-task-type/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("Type", columns, data);
}
