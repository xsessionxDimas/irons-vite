...
const handleFilterClick = () => {
  const checkSite = listStore.lastUsedFilterData.objectType !== listStore.filterData.objectType
  const checkSiteTo = listStore.lastUsedFilterData.objectTypeTo !== listStore.filterData.objectTypeTo
