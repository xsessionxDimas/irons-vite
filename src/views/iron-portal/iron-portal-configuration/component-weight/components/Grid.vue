<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="objectType" label="Component" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="weight" label="Weight" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
...
import {
  useComponentWeightListStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/component-weight/useComponentWeightListStore";
import {
  useComponentWeightFormStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/component-weight/useComponentWeightFormStore";
import {
  ListItem
...
const listStore = useComponentWeightListStore();
const formStore = useComponentWeightFormStore();
