...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Component Weight", [
    {
    ...
    },
    {
      ...
      pageRoute: "ironlake-config-component-weight",
    },
    {
      pageName: "Component Weight",
      pageRoute: "ironlake-config-component-weight",
    },
  ]);
  listStore.setPage(1);
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `ComponentWeight.xlsx`);
}
