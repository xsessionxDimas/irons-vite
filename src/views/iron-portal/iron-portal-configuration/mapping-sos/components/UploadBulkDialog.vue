<template>
  ...
  >
    <div class="text-center"></div><div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataSourceOilDatatoBUMAComponent.xlsx" target="_blank" id="link-download">here</a>
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/mapping-sos/ValidatedItem";
import {
  BulkItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/mapping-sos/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("SourceOilDatatoBUMAComponent", columns, data);
}
