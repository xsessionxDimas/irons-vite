<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
         Download template
        <a href="documents/MasterDataSOSMappingForBI.xlsx" target="_blank" id="link-download">here</a>
...
import {
  BulkItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/mapping-sos-bi/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("ModelWeight", columns, data);
}
