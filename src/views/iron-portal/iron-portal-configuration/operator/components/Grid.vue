<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="Operator" label="Operator" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'Operator')" />
      <el-table-column prop="OperatorDescription" label="Operator Description" min-width="170" sortable :sort-method="(a, b) => customSort(a, b, 'OperatorDescription')" />
