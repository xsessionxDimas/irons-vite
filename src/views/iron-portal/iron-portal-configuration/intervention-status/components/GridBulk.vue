<template>
  ...
  >
    ...
    <el-table-column prop="interventionStatus" label="Intervention Status" width="300" sortable />
    <el-table-column prop="interventionStatusDesc" label="Intervention Status Description" width="300" sortable />
    <el-table-column prop="followUpPriority" label="Follow Up Priority" width="300" sortable />
    <el-table-column prop="followUpPriorityUom" label="Follow Up Priority Uom" width="300" sortable />
