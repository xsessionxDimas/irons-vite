...
const inputValidation = Yup.object().shape({
  ...
  followUpPriority: Yup.string().required("Follow Up Priority is mandatory"),
  followUpPriorityUom: Yup.string().required("Follow Up Priority Uom is mandatory"),
...
const resetFormValue = () => {
  formData.value.interventionStatusId = 0;
  formData.value.interventionStatus = "";
  formData.value.interventionStatusDesc = "";
  formData.value.followUpPriority = "";
  formData.value.followUpPriorityUom = "";
