...
import {
  useDamageBulkStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/damage/useDamageBulkStore";
import {
  useDamageFormStore
...
const bulkStore = useDamageBulkStore();
...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Damage", [
    {
    ...
    },
    {
      ...
      pageRoute: "ironlake-config-damage",
    },
    {
      pageName: "Damage",
      pageRoute: "ironlake-config-damage",
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `Damage.xlsx`);
}
