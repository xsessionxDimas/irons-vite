<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="MaxRiskRank" label="Max Risk Ranked Interval" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="RevisedRisk" label="Revised Risk Rating" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="OverallRisk" label="Overall Risk Rating" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="FailureTiming" label="Failure Timing Risk" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="SystemImpact" label="SystemImpact Risk" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="OpsImpact" label="OPS Impact Risk" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="SupplyRisk" label="Supply Risk" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="FailureCost" label="Failure Cost Risk" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="Comments" label="Comments" min-width="300" sortable :sort-method="() => defaultSorting(columnOrder)" />
