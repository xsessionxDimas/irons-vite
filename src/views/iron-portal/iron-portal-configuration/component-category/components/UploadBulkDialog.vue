<template>
  <el-dialog
    ...
    <div class="mb-3">
      <span>
        Download template
        <a href="documents/MasterDataComponentLifeThreshold.xlsx" target="_blank" id="link-download">here</a>
...
import {
  BulkItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/component-category/BulkItem";
...
const handleDownload = () => {
  ...
  handleDataToExcel("ComponentLifeThreshold", columns, data);
}
