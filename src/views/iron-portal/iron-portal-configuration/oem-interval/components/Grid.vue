<template>
  ...
  <template v-else>
    ...
    >
      ...
      <el-table-column prop="IdOemInterval" label="ID Oem Interval" min-width="170" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="Interval" label="Interval" min-width="150" sortable :sort-method="() => defaultSorting(columnOrder)" />
      <el-table-column prop="Value" label="Value" min-width="150" sortable :sort-method="() => defaultSorting(columnOrder)" />
...
import {
  useOemIntervalFormStore
} from "@/store/pinia/iron-portal/iron-portal-configuration/oem-interval/useOemIntervalFormStore";
import {
  ListItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/oem-interval/ListItem";
import {
  PropType,
  defineProps,
  defineEmits,
...
const formStore = useOemIntervalFormStore();
