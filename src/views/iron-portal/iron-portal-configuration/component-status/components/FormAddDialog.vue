  ...
  >
    ...
    <Form id="kt_filter_form" class="row g-9 my-4" v-loading="formStore.loading">
      ...
      <AutoComplete
        ...
        name="OilDataS1"
        :max="20"
        @handleChange="handleOilDataS1Change"
      ...
      <AutoComplete
        ...
        name="OilDataS2"
        :max="20"
        @handleChange="handleOilDataS2Change"
      ...
      <AutoComplete
        ...
        name="FilterCutS1"
        :max="20"
        @handleChange="handleFilterCutS1Change"
      ...
      <AutoComplete
        ...
        name="FilterCutS2"
        :max="20"
        @handleChange="handleFilterCutS2Change"
...
const handleOilDataS1Change = (value: string) => {
  formData.value.oilDataS1 = value;
};
const handleOilDataS2Change = (value: string) => {
  formData.value.oilDataS2 = value;
};
const handleFilterCutS1Change = (value: string) => {
  formData.value.filterCutS1 = value;
};
const handleFilterCutS2Change = (value: string) => {
