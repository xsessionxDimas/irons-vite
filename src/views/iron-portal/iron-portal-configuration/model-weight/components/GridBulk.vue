<template>
  ...
  >
    ...
    <el-table-column prop="weight" label="Weight" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'weight')" />
    <el-table-column prop="whPerday" label="Wh Perday" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'whPerday')" />
    <el-table-column prop="fuelBurn" label="Fuel Burn" width="170" sortable :sort-method="(a, b) => customSort(a, b, 'fuelBurn')" />
...
import {
  ValidatedItem
} from "@/core/types/entities/iron-portal/iron-portal-configuration/model-weight/ValidatedItem";
import {
