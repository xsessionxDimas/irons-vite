...
onBeforeMount(async () => {
  ...
  setCurrentPageBreadcrumbs("Component Risk Rating", [
    {
    ...
    },
    {
      ...
      pageRoute: "ironlake-config-componentriskrating",
    },
    {
      pageName: "Component Risk Rating",
      pageRoute: "ironlake-config-componentriskrating",
    },
  ]);
  listStore.setPage(1);
  ...
  await formStore.getLookupComponentType();
  await formStore.getLookupOverallRisk();
  await formStore.getLookupFailureTiming();
  await formStore.getLookupSystemImpact();
  await formStore.getLookupOpsImpact();
  await formStore.getLookupSupplyRisk();
  await formStore.getLookupFailureCost();
});
...
const handleDownload = async () => {
  ...
  saveAs(new Blob([blob],
    { type: "application/octet-stream" }), `ComponentRiskRating.xlsx`);
}
