...
export const useOemIntervalFormStore = defineStore({
  id: "oemIntervalForm",
  state: () => {
    return {
      stateFormData: {
  ...
  actions: {
    async insertData(createBy: string) {
      try {
        ...
        const formData = {
          oemIntervalId: this.stateFormData.oemIntervalId,
          idOemInterval: this.stateFormData.idOemInterval,
          interval: this.stateFormData.interval,
    ...
    setFormData(data: ListItem) {
      this.stateFormData.oemIntervalId = data.OemIntervalId;
      this.stateFormData.idOemInterval = data.IdOemInterval;
      this.stateFormData.interval = data.Interval;
