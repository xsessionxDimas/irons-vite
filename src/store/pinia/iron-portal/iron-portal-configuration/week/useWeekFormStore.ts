...
export const useWeekFormStore = defineStore({
  id: "weekForm",
  state: () => {
    return {
      stateFormData: {
  ...
  actions: {
    async insertData(createBy: string) {
      try {
        ...
        const formData = {
          weekId: this.stateFormData.weekId,
          week: this.stateFormData.week,
          weekDescription: this.stateFormData.weekDescription,
    ...
    setFormData(data: ListItem) {
      this.stateFormData.weekId = data.WeekId;
      this.stateFormData.week = data.Week;
      this.stateFormData.weekDescription = data.WeekDescription;
