...
export const useActionFormStore = defineStore({
  id: "actionForm",
  state: () => {
    return {
      stateFormData: {
  ...
  actions: {
    async insertData(createBy: string) {
      try {
        ...
        const formData = {
          actionId: this.stateFormData.actionId,
          action: this.stateFormData.action,
          actionDescription: this.stateFormData.actionDescription,
    ...
    setFormData(data: ListItem) {
      this.stateFormData.actionId = data.ActionId;
      this.stateFormData.action = data.Action;
      this.stateFormData.actionDescription = data.ActionDescription;
