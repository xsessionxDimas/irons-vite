...
export const useInspectionFormStore = defineStore({
  id: "inspectionForm",
  state: () => {
    return {
      stateFormData: {
  ...
  actions: {
    async insertData(createBy: string) {
      try {
        ...
        const formData = {
          inspectionId: this.stateFormData.inspectionId,
          inspection: this.stateFormData.inspection,
          inspectionDescription: this.stateFormData.inspectionDescription,
    ...
    setFormData(data: ListItem) {
      this.stateFormData.inspectionId = data.InspectionId;
      this.stateFormData.inspection = data.Inspection;
      this.stateFormData.inspectionDescription = data.InspectionDescription;
