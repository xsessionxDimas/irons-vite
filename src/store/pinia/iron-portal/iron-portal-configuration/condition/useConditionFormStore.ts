...
export const useConditionFormStore = defineStore({
  id: "conditionForm",
  state: () => {
    return {
      stateFormData: {
  ...
  actions: {
    async insertData(createBy: string) {
      try {
        ...
        const formData = {
          conditionId: this.stateFormData.conditionId,
          condition: this.stateFormData.condition,
          conditionDescription: this.stateFormData.conditionDescription,
    ...
    setFormData(data: ListItem) {
      this.stateFormData.conditionId = data.ConditionId;
      this.stateFormData.condition = data.Condition;
      this.stateFormData.conditionDescription = data.ConditionDescription;
