...
export const useDamageFormStore = defineStore({
  id: "damageForm",
  state: () => {
    return {
      stateFormData: {
  ...
  actions: {
    async insertData(createBy: string) {
      try {
        ...
        const formData = {
          damageId: this.stateFormData.damageId,
          damage: this.stateFormData.damage,
          damageDescription: this.stateFormData.damageDescription,
    ...
    setFormData(data: ListItem) {
      this.stateFormData.damageId = data.DamageId;
      this.stateFormData.damage = data.Damage;
      this.stateFormData.damageDescription = data.DamageDescription;
