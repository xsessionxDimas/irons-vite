...
export const useParameterObjectFormStore = defineStore({
  id: "parameterObjectForm",
  state: () => {
    return {
      stateFormData: {
        ...initialForm
  ...
  actions: {
    async insertData(createBy: string) {
      try {
        ...
        const formData = {
          parameterObjectId: this.stateFormData.parameterObjectId,
          parameterObject: this.stateFormData.parameterObject,
          parameterObjectDescription: this.stateFormData.parameterObjectDescription,
    ...
    setFormData(data: ListItem) {
      this.stateFormData.parameterObjectId = data.ParameterObjectId;
      this.stateFormData.parameterObject = data.ParameterObject;
      this.stateFormData.parameterObjectDescription = data.ParameterObjectDescription;
