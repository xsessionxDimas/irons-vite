...
export const useOperatorFormStore = defineStore({
  id: "0peratorForm",
  state: () => {
    return {
      stateFormData: {
  ...
  actions: {
    async insertData(createBy: string) {
      try {
        ...
        const formData = {
          operatorId: this.stateFormData.operatorId,
          operator: this.stateFormData.operator,
          operatorDescription: this.stateFormData.operatorDescription,
    ...
    setFormData(data: ListItem) {
      this.stateFormData.operatorId = data.OperatorId;
      this.stateFormData.operator = data.Operator;
      this.stateFormData.operatorDescription = data.OperatorDescription;
