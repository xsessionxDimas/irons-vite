...
export const useCharacteristicTypeValueFormStore = defineStore({
  id: "CharacteristicTypeValueForm",
  state: () => {
    return {
      stateFormData: {
  ...
  actions: {
    ...
    setFormData(data: ListItem) {
      this.stateFormData.mdCharacteristicTypeValueId = data.mdCharacteristicTypeValueId || 0;
