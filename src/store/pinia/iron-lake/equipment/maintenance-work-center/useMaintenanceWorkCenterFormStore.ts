...
export const useMaintenanceWorkCenterFormStore = defineStore({
  id: "maintenanceWorkCenterForm",
  state: () => {
    return {
      stateFormData: {
  ...
  actions: {
    ...
    setFormData(data: ListItem) {
      this.stateFormData.MaintenanceWorkCenterId = data.maintenanceWorkCenterId || 0;
      this.stateFormData.MaintenanceWorkCenter = data.maintenanceWorkCenter || "";
      this.stateFormData.MaintenanceWorkCenterDescription = data.maintenanceWorkCenterDescription || "";
