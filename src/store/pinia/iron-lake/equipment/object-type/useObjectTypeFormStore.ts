...
export const useObjectTypeFormStore = defineStore({
  id: "objectTypeForm",
  state: () => {
    return {
      stateFormData: {
  ...
  actions: {
    ...
    setFormData(data: ListItem) {
      this.stateFormData.ObjectTypeId = data.objectTypeId || 0;
      this.stateFormData.ObjectType = data.objectType || "";
      this.stateFormData.ObjectTypeDescription = data.objectTypeDescription || "";
