...
export const useEquipmentTypeFormStore = defineStore({
  ...
  actions: {
    ...
    setFormData(data: ListItem) {
      this.stateFormData.EquipmentTypeId = data.equipmentTypeId || 0;
      this.stateFormData.EquipmentType = data.equipmentType || "";
      this.stateFormData.EquipmentTypeDescription = data.equipmentTypeDescription || "";
