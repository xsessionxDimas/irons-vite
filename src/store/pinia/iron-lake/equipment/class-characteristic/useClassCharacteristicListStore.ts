...
import {
  LookupItem
} from "@/core/types/entities/iron-lake/equipment/class-characteristic/LookupItem";
...
export const useClassCharacteristicListStore = defineStore({
  id: "classCharacteristicList",
  state: () => {
    return {
      stateFilterData: {
        ...initialFilter
      ...
      statePageName: "classCharacteristic",
  ...
  actions: {
    async getData(isPageRefresh = true) {
      const params = {
        class: this.stateFilterData.class,
        classTo: this.stateFilterData.classTo,
    ...
    async getLookup() {
      ...
      try {
        ...
        this.stateClassOption = mapOption(response.data.result.content.class);
    ...
    setClass(value: string) {
      this.stateFilterData.class = value;
    },
    setClassTo(value: string) {
      this.stateFilterData.classTo = value;
    },
    ...
    async resetFilter() {
      this.stateFilterData.class = "";
      this.stateFilterData.classTo = "";
      ...
      const checkClass = this.stateLastUsedFilterData.class !== "";
      const checkClassTo = this.stateLastUsedFilterData.classTo !== "";
      ...
      if (checkClass || checkClassTo || checkCharacteristicType || checkCharacteristicTypeTo || checkStartDate || checkStartDateTo || checkEndDate || checkEndDateTo) {
        await this.getData()
      }
    },
    resetState() {
