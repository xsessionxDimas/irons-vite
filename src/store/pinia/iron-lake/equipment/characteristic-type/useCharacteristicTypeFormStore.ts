...
export const useCharacteristicTypeFormStore = defineStore({
  id: "characteristicTypeForm",
  state: () => {
    return {
      stateFormData: {
        ...initialForm
  ...
  actions: {
    async insertData(createBy: string) {
      try {
        ...
        const formData = {
          characteristicTypeId: this.stateFormData.characteristicTypeId,
          characteristicType: this.stateFormData.characteristicType,
          characteristicTypeDescription: this.stateFormData.characteristicTypeDescription,
    ...
    setFormData(data: ListItem) {
      this.stateFormData.characteristicTypeId = data.characteristicTypeId || 0;
      this.stateFormData.characteristicType = data.characteristicType || "";
      this.stateFormData.characteristicTypeDescription = data.characteristicTypeDescription || "";
