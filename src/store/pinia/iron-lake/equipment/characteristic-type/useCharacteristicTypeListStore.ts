...
import {
  FilterData
} from "@/core/types/entities/iron-lake/equipment/characteristic-type/FilterData";
import {
  LookupItem
} from "@/core/types/entities/iron-lake/equipment/characteristic-type/LookupItem";
...
export const useCharacteristicTypeListStore = defineStore({
  id: "characteristicTypeList",
  state: () => {
    return {
      stateFilterData: {
        ...initialFilter
  ...
  actions: {
    ...
    async resetFilter() {
      ...
      if (checkCharacteristicType || checkCharacteristicTypeTo || checkStartDate || checkStartDateTo || checkEndDate || checkEndDateTo) {
        await this.getData()
      }
    },
    resetState() {
