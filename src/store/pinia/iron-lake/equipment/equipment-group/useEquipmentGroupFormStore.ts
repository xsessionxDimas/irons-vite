...
export const useEquipmentGroupFormStore = defineStore({
  id: "equipmentGroupForm",
  state: () => {
    return {
      stateFormData: {
        EquipmentGroupId: 0,
  ...
  actions: {
    ...
    setFormData(data: ListItem) {
      this.stateFormData.EquipmentGroupId = data.equipmentGroupId || 0;
      this.stateFormData.EquipmentGroup = data.equipmentGroup || "";
      this.stateFormData.EquipmentGroupDescription = data.equipmentGroupDescription || "";
