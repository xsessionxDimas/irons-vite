...
import {
  ListItem
} from "@/core/types/entities/iron-lake/equipment/class/ListItem";
import {
  FilterData
} from "@/core/types/entities/iron-lake/equipment/class/FilterData";
import {
  LookupItem
} from "@/core/types/entities/iron-lake/equipment/class/LookupItem";
...
export const useClassListStore = defineStore({
  ...
  actions: {
    ...
    async resetFilter() {
      ...
      if (checkClass || checkClassTo || checkStartDate || checkStartDateTo || checkEndDate || checkEndDateTo) {
        await this.getData()
      }
    },
    resetState() {
