...
export const useClassFormStore = defineStore({
  id: "classForm",
  state: () => {
    return {
      stateFormData: {
  ...
  actions: {
    async insertData(createBy: string) {
      try {
        ...
        const formData = {
          classId: this.stateFormData.classId,
          class: this.stateFormData.class,
          classDescription: this.stateFormData.classDescription,
    ...
    setFormData(data: ListItem) {
      this.stateFormData.classId = data.classId || 0;
      this.stateFormData.class = data.class || "";
      this.stateFormData.classDescription = data.classDescription || "";
