...
export const useCostCenterFormStore = defineStore({
  id: "costCenterForm",
  state: () => {
    return {
      stateFormData: {
  ...
  actions: {
    ...
    setFormData(data: ListItem) {
      this.stateFormData.CostCenterId = data.costCenterId || 0;
      this.stateFormData.CostCenter = data.costCenter || "";
      this.stateFormData.CostCenterDescription = data.costCenterDescription || "";
