...
export const useCharacteristicValueFormStore = defineStore({
  id: "characteristicValueForm",
  state: () => {
    return {
      stateFormData: {
        ...initialForm
  ...
  actions: {
    async insertData(createBy: string) {
      try {
        ...
        const formData = {
          characteristicValueId: this.stateFormData.characteristicValueId,
          characteristicValue: this.stateFormData.characteristicValue,
          characteristicValueDescription: this.stateFormData.characteristicValueDescription,
    ...
    setFormData(data: ListItem) {
      this.stateFormData.characteristicValueId = data.characteristicValueId || 0;
      this.stateFormData.characteristicValue = data.characteristicValue || "";
      this.stateFormData.characteristicValueDescription = data.characteristicValueDescription || "";
