...
import {
  FilterData
} from "@/core/types/entities/iron-lake/equipment/characteristic-value/FilterData";
import {
  LookupItem
} from "@/core/types/entities/iron-lake/equipment/characteristic-value/LookupItem";
...
export const useCharacteristicValueListStore = defineStore({
  id: "characteristicValueList",
  state: () => {
    return {
      stateFilterData: {
        ...initialFilter
      ...
      statePageName: "characteristicValue",
  ...
  actions: {
    ...
    async resetFilter() {
      ...
      if (checkCharacteristicValue || checkCharacteristicValueTo || checkStartDate || checkStartDateTo || checkEndDate || checkEndDateTo) {
        await this.getData()
      }
    },
    resetState() {
