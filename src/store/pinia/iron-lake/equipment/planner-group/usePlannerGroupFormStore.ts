...
export const usePlannerGroupFormStore = defineStore({
  id: "plannerGroupForm",
  state: () => {
    return {
      stateFormData: {
  ...
  actions: {
    ...
    setFormData(data: ListItem) {
      this.stateFormData.PlannerGroupId = data.plannerGroupId || 0;
      this.stateFormData.PlannerGroup = data.plannerGroup || "";
      this.stateFormData.PlannerGroupDescription = data.plannerGroupDescription || "";
