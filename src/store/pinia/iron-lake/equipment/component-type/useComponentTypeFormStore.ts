...
export const useComponentTypeFormStore = defineStore({
  id: "componentTypeForm",
  state: () => {
    return {
      stateFormData: {
        ComponentTypeId: 0,
  ...
  actions: {
    ...
    setFormData(data: ListItem) {
      this.stateFormData.ComponentTypeId = data.componentTypeId || 0;
      this.stateFormData.ComponentType = data.componentType || "";
      this.stateFormData.ComponentTypeDescription = data.componentTypeDescription || "";
