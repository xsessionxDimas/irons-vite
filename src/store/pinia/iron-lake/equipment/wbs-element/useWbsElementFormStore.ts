...
export const useWbsElementFormStore = defineStore({
  id: "wbsElementForm",
  state: () => {
    return {
      stateFormData: {
  ...
  actions: {
    ...
    setFormData(data: ListItem) {
      this.stateFormData.WbsElementId = data.wbsElementId || 0;
      this.stateFormData.WbsElement = data.wbsElement || "";
      this.stateFormData.WbsElementDescription = data.wbsElementDescription || "";
