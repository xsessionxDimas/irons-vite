...
import {
  LookupItem
} from "@/core/types/entities/iron-lake/business-partner/customer/LookupItem";
...
export const useCustomerListStore = defineStore({
  id: "customerList",
  state: () => {
    return {
      stateFilterData: {
      ...
      statePageName: "customer",
      stateDisplayData: [] as ListItem[],
      statePagination: new PaginationType(),
      stateLoading: false as boolean,
      statePaginationLoading: false as boolean,
      stateCustomerOption: [] as Option[],
      stateCustomerDescOption: [] as Option[]
    }
  },
  getters: {
    pageName: (state) => {
    ...
    customerDescOption: (state) => {
      return state.stateCustomerDescOption;
    }
  },
  actions: {
    async getData(isPageRefresh = true) {
      const params = {
        ...
        CustomerDescription: this.stateFilterData.CustomerDescription,
    ...
    async getLookup() {
      ...
      try {
        ...
        this.stateCustomerDescOption = mapOption(response.data.result.content.customerDescription);
      } catch (error) {
        console.log(error)
      }
    },
    ...
    setCustomerDescription(value: string) {
      this.stateFilterData.CustomerDescription = value;
    },
    async resetFilter() {
      this.stateFilterData.Customer = ""
      this.stateFilterData.CustomerDescription = ""
      const checkCustomer = this.stateLastUsedFilterData.Customer !== ""
      const checkCustomerDesc = this.stateLastUsedFilterData.CustomerDescription !== ""
      if (checkCustomer || checkCustomerDesc) {
        await this.getData()
      }
    },
    resetState() {
