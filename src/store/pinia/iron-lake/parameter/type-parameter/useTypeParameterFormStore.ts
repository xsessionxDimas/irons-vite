...
export const useTypeParameterFormStore = defineStore({
  id: "typeParameterForm",
  state: () => {
    return {
      stateFormData: {
        ...initialForm
  ...
  actions: {
    async insertData(createBy: string) {
      try {
        ...
        const formData = {
          mdTypeParameterId: this.stateFormData.mdTypeParameterId,
          idParameter: this.stateFormData.idParameter,
    ...
    setFormData(data: ListItem) {
      this.stateFormData.mdTypeParameterId = data.mdTypeParameterId || 0;
      this.stateFormData.idParameter = data.idParameter || "";
