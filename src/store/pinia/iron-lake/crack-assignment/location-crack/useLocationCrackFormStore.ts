...
export const useLocationCrackFormStore = defineStore({
  id: "locationCrackForm",
  state: () => {
    return {
      stateFormData: {
        ...initialForm
  ...
  actions: {
    async insertData(createBy: string) {
      try {
        ...
        const formData = {
          LocationCrackId: this.stateFormData.LocationCrackId,
          locationId: this.stateFormData.locationId,
          locationDescription: this.stateFormData.locationDescription,
    ...
    setFormData(data: ListItem) {
      this.stateFormData.LocationCrackId = data.locationCrackId || 0;
      this.stateFormData.locationId = data.locationId || "";
      this.stateFormData.locationDescription = data.locationDescription || "";
