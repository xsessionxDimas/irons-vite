...
export const useInterimSuspensionCylinderFormStore = defineStore({
  id: "InterimSuspensionCylinderForm",
  state: () => {
    return {
  ...
  actions: {
    ...
    async submitForm() {
      ...
      console.log("berhasil update detail", res);
      // update header to BE
      const headerBody = {
      ...
      console.log("berhasil update header", headerRes);
    }
  }
})
