...
} from "../interim-engine-service/defects/urls"
...
} from "../interim-engine-service/defects/useInterimDefectsFormStore"
import { sendErrorEvent } from "@/core/helpers/analytics";

export const useInterimPreviewDefectFormStore = defineStore({
  id: "InterimdefectPreview",
  state: () => {
    return {
      stateLoading: false,
