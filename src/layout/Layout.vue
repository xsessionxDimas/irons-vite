<template>
  ...
  <div class="page d-flex flex-row flex-column-fluid">
    ...
    <div id="kt_wrapper" class="d-flex flex-column flex-row-fluid wrapper">
      ...
      <!-- begin:: Content -->
      <div id="kt_content" class="content d-flex flex-column flex-column-fluid" style="padding: 5px 0; width: 100%">
        <KTToolbar
          v-if="['ironlake', 'all_equipment', 'dailyschedule', 'employee', 'site', 'ironportal', 'administration', 'report'].includes(routeName as string) ? false : subheaderDisplay"
