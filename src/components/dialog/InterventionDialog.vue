<template>
    ...
    <SelectSearchWithIcon :data="data" :display-label="true" @on-focus="() => { topOffset = '15vh'; }" @on-lost-focus="() => { topOffset = '25vh' }"  :placeholder="placeholder" @on-selected="onWorkOrderSelected" :dialogVisible="dialogVisible" />
    <template #footer>
...
import SelectSearchWithIcon from '@/components/inputs/dma/SelectSearchWithIcon.vue'
...
const props = defineProps({
  ...
  placeholder: {
    required: false,
    type: String,
    default: "Outstanding Component Interventions"
  }
});
