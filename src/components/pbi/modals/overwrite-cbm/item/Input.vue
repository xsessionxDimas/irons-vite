<template>
  <div :class="[widthStyle, potraitWidthStyle, paddingBottomCondition]" class="input-eform-status" :style="style">
    <el-input
      ref="cbmInput"
...
const emits = defineEmits(['onCalculating'])
...
// const oldValueDropdownTool = ref("")
