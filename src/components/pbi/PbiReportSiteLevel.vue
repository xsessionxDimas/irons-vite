    ...
    if (typeof pbiConfig.value !== "undefined") {
      ...
      report.on("loaded", async () => {
        ...
        const page = pages.find((p) => {
          return p.displayName === "Site Level" // get tab Site Level
        });
        ...
        if (loggedInUserLocation && loggedInUserLocation !== "AU02") {
          ...
          embedContainer = document.getElementById("siteLevelContainer")!;
...
const tableDataSelected = (tableDataArray: Array<any>) => {
  ...
  if (
    ...
    console.log("There are some unprovided data")
  }
}
