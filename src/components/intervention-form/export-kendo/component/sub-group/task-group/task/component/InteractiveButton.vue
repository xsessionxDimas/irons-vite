<template>
  <div :class="[widthStyle, textAlign, potraitWidthStyle]" class="px-2 py-2" :style="props.task && props.task.isShowAdjustmentRow? `${style}border-bottom:0px;margin-bottom:0px;` : style">
