...
import InformationPopUp from '../dialog/InformationPopUp.vue';
...
const content = computed(() => {
  return props.item.value ? addSpanOnHyphen(props.item.value).replaceAll('{BLOB_URL}', import.meta.env.VITE_APP_BASE_URL_VERSIONING_DIGITAL) : ''
})
...
const style = computed(() => {
  ...
  return `${backGroundColor}${fontColor}${borderTop}${borderRight}${borderBottom}${borderLeft}${borderRadiusTopRight}${borderRadiusBottomRight}${borderRadiusTopLeft}${borderRadiusBottomLeft}${paddingRight}`
})
