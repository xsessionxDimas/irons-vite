<template>
  <div :class="[widthStyle]" class="px-2 pt-2" :style="props.task && props.task.isShowAdjustmentRow? `${style}border-bottom:0px;margin-bottom:0px;` : style">
...
const styleBorderFont = computed(() => {
  ...
  } else if (val == '2' || (val == '3' && taskPropsItem.value?.category == 'CRACK') || (val == '3' && taskPropsItem.value?.rating == 'SERVICE_CLEANED_AND_REPLACED')) {
